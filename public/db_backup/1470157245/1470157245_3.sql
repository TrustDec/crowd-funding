...
CREATE TABLE `%DB_PREFIX%log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=3147 DEFAULT CHARSET=utf8 COMMENT='//记录';
...
INSERT INTO `%DB_PREFIX%log` VALUES ('3129','更新系统配置','1470070936','1','113.140.25.138','1','Conf','update');
INSERT INTO `%DB_PREFIX%log` VALUES ('3130','更新系统配置','1470070953','1','113.140.25.138','1','Conf','update');
INSERT INTO `%DB_PREFIX%log` VALUES ('3131','更新系统配置','1470071153','1','113.140.25.138','1','Conf','update');
INSERT INTO `%DB_PREFIX%log` VALUES ('3132','更新系统配置','1470071249','1','113.140.25.138','1','Conf','update');
INSERT INTO `%DB_PREFIX%log` VALUES ('3133','更新系统配置','1470071388','1','113.140.25.138','1','Conf','update');
INSERT INTO `%DB_PREFIX%log` VALUES ('3134','更新系统配置','1470071607','1','113.140.25.138','1','Conf','update');
INSERT INTO `%DB_PREFIX%log` VALUES ('3135','更新系统配置','1470071619','1','113.140.25.138','1','Conf','update');
INSERT INTO `%DB_PREFIX%log` VALUES ('3136','admin登录成功','1470072990','1','113.140.25.138','1','Public','do_login');
INSERT INTO `%DB_PREFIX%log` VALUES ('3137','admin登录成功','1470073001','1','113.140.25.138','1','Public','do_login');
INSERT INTO `%DB_PREFIX%log` VALUES ('3138','admin登录成功','1470076179','1','113.140.25.138','1','Public','do_login');
INSERT INTO `%DB_PREFIX%log` VALUES ('3139','admin登录成功','1470081915','1','113.140.25.138','1','Public','do_login');
INSERT INTO `%DB_PREFIX%log` VALUES ('3140','admin登录成功','1470155976','1','113.140.25.138','1','Public','do_login');
INSERT INTO `%DB_PREFIX%log` VALUES ('3141','更新系统配置','1470156036','1','113.140.25.138','1','Conf','update');
INSERT INTO `%DB_PREFIX%log` VALUES ('3142','admin登录成功','1470156057','1','113.140.25.138','1','Public','do_login');
INSERT INTO `%DB_PREFIX%log` VALUES ('3143','admin登录成功','1470156060','1','113.140.25.138','1','Public','do_login');
INSERT INTO `%DB_PREFIX%log` VALUES ('3144','管理员操作','1470156623','1','113.140.25.138','1','User','modify_account');
INSERT INTO `%DB_PREFIX%log` VALUES ('3145','668jk彻底删除成功','1470156786','1','113.140.25.138','1','User','delete');
INSERT INTO `%DB_PREFIX%log` VALUES ('3146','管理员操作','1470156807','1','113.140.25.138','1','User','modify_account');
...
CREATE TABLE `%DB_PREFIX%mobile_verify_code` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=27 DEFAULT CHARSET=utf8 COMMENT='//手机验证';
INSERT INTO `%DB_PREFIX%mobile_verify_code` VALUES ('26','799937','17809282642','1470156299','113.140.25.138','');
...
CREATE TABLE `%DB_PREFIX%payment_notice` (
  ...
  KEY `deal_id` (`deal_id`)
) ENGINE=MyISAM AUTO_INCREMENT=210 DEFAULT CHARSET=utf8 COMMENT='// 付款单号列表';
INSERT INTO `%DB_PREFIX%payment_notice` VALUES ('209','20160803169','1470156462','0','0','0','64','25','','','10000000000.00','','0','0','','0','0','0');
