            ...
            <div id="body" style="clear:left">
                <dl class="content">
                  ...
                  <dd>
                        ...
                        <input size="30" name="WIDseller_email" value="yutuanwang@sina.com" />
                        <span></span>
                    </dd>
                    <dt>商户订单号：</dt>
                    <dd>
                        <span class="null-star">*</span>
                        <input size="30" name="WIDout_trade_no" value="<?php echo rand(999,999999999) ?>" />
                        <span></span>
                    </dd>
                    <dt>订单名称：</dt>
                    <dd>
                        <span class="null-star">*</span>
                        <input size="30" name="WIDsubject" value="测试产品" />
                        <span></span>
                    </dd>
                    <dt>付款金额：</dt>
                    <dd>
