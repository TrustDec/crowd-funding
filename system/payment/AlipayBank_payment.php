...
class AlipayBank_payment implements payment {
	...
	public function get_payment_code($payment_notice_id)
	{
		...
		$payLinks = '<form action="https://mapi.alipay.com/gateway.do?'.$param. '&sign='.$sign_md5.'&sign_type=MD5" id="jumplink" method="post">'.sprintf($this->payment_lang['GO_TO_PAY'],$this->get_name($bank_type)).'</form>';
