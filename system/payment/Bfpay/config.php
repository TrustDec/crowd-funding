...
if(!defined('APP_ROOT_PATH')) 
	define('APP_ROOT_PATH', str_replace('system/payment/Bfpay/config.php', '', str_replace('\\', '/', __FILE__)));
	
	
return  $config_ini = array(
	'InterfaceVersion' =>"4.0",//接口版本号Int ,现接口版本为 4.0
	'PageUrl' =>get_domain().APP_ROOT.'/wbfpay_web/merchant_url.php',//页面通知地址String,需 URL 编码，长度不超过 255 位
