...
class RSAUtils{
	...
	public static function decryptByPublicKey($data) {
		$pu_key =  openssl_pkey_get_public(file_get_contents(APP_ROOT_PATH.'system/payment/jdpay/wy_rsa_public_key_production.pem'));//这个函数可用来判断公钥是否是可用的，可用返回资源id Resource id
		$decrypted = "";
