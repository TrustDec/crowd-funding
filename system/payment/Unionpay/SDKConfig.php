...
define("SDK_SIGN_CERT_PATH",UNIONPAY_CERTS_PATH.'PM_07_acp.pfx');
// 签名证书密码
define("SDK_SIGN_CERT_PWD",SDK_SIGN_CERT_PWD_2);

//验签证书
//define("SDK_VERIFY_CERT_PATH",UNIONPAY_CERTS_PATH.'UpopRsaCert.cer');
//密码加密证书
//define("UNIONPAY_CERTS_PATH.'RSA2048_PROD_index_22.cer');
//验签证书路径
define("SDK_VERIFY_CERT_DIR",UNIONPAY_CERTS_PATH);
