<?php
//底部文章
class deal_house_cate_auto_cache extends auto_cache{
	public function load($param)
	{
		...
		{
			$deal_house_cate = $GLOBALS['db']->getAll("select * from ".DB_PREFIX."deal_house_cate where is_effect=1");
			$deal_cate_array=array();
			foreach($deal_house_cate as $k=>$v){
