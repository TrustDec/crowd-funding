	...
	$("#add_update").bind("click",function(){		
		...
		$.ajax({ 
			...
			success: function(ajaxobj){
				if(ajaxobj.status==1)
				{
					$.weeboxs.open(ajaxobj.html, {boxid:'add_update',contentType:'text',showButton:false, showCancel:false, showOk:false,title:'更新动态',width:600,type:'wee',onopen:function(){
						init_ui_select();
					}});
					bind_update_form();					
				}
