$(function(){
	...
	button_hover(".ui-button");
   	...
   	button_hover(".ui-small-center-button");
...
function button_hover(hoverObj){
 	$(hoverObj).hover(function(){
		if($(this).hasClass("theme_bgcolor")){
			$(this).addClass("theme_bgcolor1").removeClass("theme_bgcolor");
		}
		if($(this).hasClass("bg_red")){
			$(this).addClass("bg_red1").removeClass("bg_red");
		}
		if($(this).hasClass("bg_gray")){
			$(this).addClass("bg_gray1").removeClass("bg_gray");
		}
		if($(this).hasClass("bg_green")){
			$(this).addClass("bg_green1").removeClass("bg_green");
		}
	},function(){
		if($(this).hasClass("theme_bgcolor1")){
			$(this).addClass("theme_bgcolor").removeClass("theme_bgcolor1");
		}
		if($(this).hasClass("bg_red1")){
			$(this).addClass("bg_red").removeClass("bg_red1");
		}
		if($(this).hasClass("bg_gray1")){
			$(this).addClass("bg_gray").removeClass("bg_gray1");
		}
		if($(this).hasClass("bg_green1")){
			$(this).addClass("bg_green").removeClass("bg_green1");
		}
	});
}
