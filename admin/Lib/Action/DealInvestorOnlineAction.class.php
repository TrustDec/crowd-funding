...
class DealInvestorOnlineAction extends CommonAction{
/**
 * 上线列表
 */
 ...
 */
	...
	public function view()
	{
		...
		$this->assign("back_list",u("DealInvestorOnline/get_pay_list",array("deal_id"=>$order_info['deal_id'])));		
		$this->display();
	}
