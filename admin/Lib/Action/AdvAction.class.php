...
//		$this->ajaxReturn($tmpl_files);
	...
	public function add()
	{
		...
		//有广告位的模板
	    $tmpl_files = array();
	    $tmpl_files[]='deal_investor_show.html';
	    $tmpl_files[]='deals_index.html';
	    $tmpl_files[]='faq_index.html';
	    $tmpl_files[]='finance/company_deals_list.html';
	    $tmpl_files[]='help_show.html';
	    $tmpl_files[]='homes_index.html';
	    $tmpl_files[]='index.html';
	    $tmpl_files[]='invester_list.html';
	    $tmpl_files[]='news.html';
	    $tmpl_files[]='stock_transfer_list.html';
	    $this->assign("file",$tmpl_files);
		$this->display();
	}
