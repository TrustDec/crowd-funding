...
$(document).ready(function(){	
		...
		$("#earnings_button").setEarnings();
		$("#earnings_button").bind('click',function(){
			$("#earnings_button").setEarnings();
		});
});
...
$.fn.setEarnings=function(){
	var is_earnings=$(this).val();
	if(is_earnings ==1)
	{
		$(".earnings_class").show();
		$(".earnings_class .earnings_child").addClass("require");
	}
	else
	{
		$(".earnings_class").hide();
		$(".earnings_class .earnings_child").removeClass("require");
	}
}
