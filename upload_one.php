...
require './app/Lib/app_init.php';
	    ...
	    $img_result = save_image_upload($_FILES,"idcard_zheng","attachment/".$dir,$whs=array('thumb'=>array(205,160,1,0)),1,1);
	    else
		$img_result = save_image_upload($_FILES,"idcard_zheng","attachment/".$dir,$whs=array('thumb'=>array(205,160,1,0)),0,1);	
		...
		$file_url = $img_result['idcard_zheng']['url'];
		$thumb_url = $img_result['idcard_zheng']['thumb']['thumb']['url'];
		...
		es_session::set("deal_image1",$data);
