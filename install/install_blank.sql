...
(1, 'admin', '21232f297a57a5a743894a0e4a801fc3', 1, 0, 4, 1453143765, '::1'),
(4, 'test', '098f6bcd4621d373cade4e832627b4f6', 1, 0, 4, 1453145662, '::1');
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='//广告位' AUTO_INCREMENT=44 ;
...
CREATE TABLE IF NOT EXISTS `%DB_PREFIX%api_login` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='// 登录接口' AUTO_INCREMENT=15 ;

--
-- 转存表中的数据 `%DB_PREFIX%api_login`
--

INSERT INTO `%DB_PREFIX%api_login` (`id`, `name`, `config`, `class_name`, `icon`, `bicon`, `is_weibo`, `dispname`) VALUES
...
CREATE TABLE IF NOT EXISTS `%DB_PREFIX%article` (
  ...
  KEY `sort` (`sort`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='//文章列表' AUTO_INCREMENT=81 ;

--
-- 转存表中的数据 `%DB_PREFIX%article`
--

INSERT INTO `%DB_PREFIX%article` (`id`, `title`, `content`, `cate_id`, `create_time`, `update_time`, `add_admin_id`, `is_effect`, `rel_url`, `update_admin_id`, `is_delete`, `click_count`, `sort`, `seo_title`, `seo_keyword`, `seo_description`, `uname`, `sub_title`, `brief`, `is_week`, `is_hot`, `icon`, `writer`, `tags`) VALUES
...
(76, '【媒体报道】众筹平台助“印象”打造专业川菜连锁品牌', '三顾茅庐，方识茅庐真印象!目前已经拥有直营店的平台，10月18号将与平台投资人见面。\r\n<p>\r\n	<br />\r\n</p>\r\n<p>\r\n	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <img alt="" src="http://www.renrentou.com/s/upload/editor/2014/10images/141016102309036310fuv8e.jpg" style="height:427px;width:651px;" />\r\n</p>\r\n<p>\r\n	<br />\r\n　　融资计划\r\n</p>\r\n<p>\r\n	<br />\r\n　众筹平台的建立，将进一步提高本服务水平\r\n</p>\r\n<p>\r\n	<br />\r\n　　项目特色\r\n</p>\r\n<p>\r\n	<br />\r\n　项目特色信息\r\n</p>\r\n<p>\r\n	<br />\r\n　　项目背景\r\n</p>\r\n<p>\r\n	　跨济南、济区域，并保持良好增长势头。广大爱好美食的投资朋友们，这样好的赚钱投资机会你想拥有吗?赶紧关注众筹平台吧。\r\n</p>\r\n<p>\r\n	<br />\r\n　　市场优势\r\n</p>\r\n<p>\r\n	<br />\r\n　　拥有多年品牌积淀，就餐环境良好好，价格符合大众消费，是商场餐饮业市场中目前仅有的大众定位的川菜连锁品牌。另外，印象中央厨房的可复制性研发，品牌发展及品质保证，开业即火爆，市场潜力巨大。目前，印象已跨济南、济区域，并保持良好增长势头。广大爱好美食的投资朋友们，这样好的赚钱投资机会你想拥有吗?赶紧关注众筹平台吧。\r\n</p>', 26, 1413586791, 1434136558, 0, 1, '', 0, 0, 0, 8, '', '', '', '', '', '', 1, 1, '', '方维众筹', '媒体'),
(78, '版权申明', '该系统知识产权归我方所有，<span style="font-family:''宋体'';">未经书面许可，不得以任何形式公布“软件产品”的源码，并不得复制、传播、出售、出租、出借等。</span><!--[if gte mso 9]><![endif]-->', 21, 1413588553, 1434136537, 0, 1, '', 0, 0, 0, 10, '', '', '', '', '', '', 1, 1, '', '方维众筹', '版权'),
(79, '会员注册', '', 28, 1413588976, 1434136523, 0, 1, 'user-register', 0, 0, 0, 11, '', '', '', '', '', '', 1, 1, '', '方维众筹', '会员'),
(80, '发起项目', '', 28, 1413589126, 1434136507, 0, 1, '/zc_svn/project', 0, 0, 0, 12, '', '', '', '', '', '', 1, 1, './public/attachment/201412/08/10/548507b508df3.jpg', '方维众筹', '热门');
...
CREATE TABLE IF NOT EXISTS `%DB_PREFIX%article_cate` (
  ...
  KEY `type_id` (`type_id`),
  KEY `sort` (`sort`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='//文章分类' AUTO_INCREMENT=29 ;

--
-- 转存表中的数据 `%DB_PREFIX%article_cate`
--

INSERT INTO `%DB_PREFIX%article_cate` (`id`, `title`, `brief`, `pid`, `is_effect`, `is_delete`, `type_id`, `sort`, `seo_title`) VALUES
(21, '站点申明', '', 0, 1, 0, 1, 10, 'zdsm'),
(22, '关于我们', '', 0, 1, 0, 1, 0, 'gywm'),
(23, '众筹简介', '众筹简介', 0, 1, 1, 0, 3, ''),
(24, '新手帮助', '', 0, 1, 0, 1, 1, 'xsbz'),
(25, '活动报名', '', 0, 1, 0, 0, 5, 'hdbm'),
(26, '媒体报道', '', 0, 1, 0, 0, 6, 'mtbd'),
(27, '合作方式', '', 0, 1, 0, 1, 7, 'hzfs'),
(28, '我有项目', '', 0, 1, 0, 1, 8, 'wyxm');
...
INSERT INTO `%DB_PREFIX%bank` (`id`, `name`, `is_rec`, `day`, `sort`, `icon`, `is_support_tzt`) VALUES
(1, '中国工商银行', 1, 3, 0, './public/bank/1.jpg', 0),
(2, '中国农业银行', 1, 3, 0, './public/bank/2.jpg', 0),
(3, '中国建设银行', 1, 3, 0, './public/bank/3.jpg', 0),
(4, '招商银行', 1, 3, 0, './public/bank/4.jpg', 0),
(5, '中国光大银行', 1, 3, 0, './public/bank/5.jpg', 0),
(6, '中国邮政储蓄银行', 1, 3, 0, './public/bank/6.jpg', 0),
(7, '兴业银行', 1, 3, 0, './public/bank/7.jpg', 0),
(8, '中国银行', 0, 3, 0, './public/bank/8.jpg', 0),
(9, '交通银行', 0, 3, 3, './public/bank/9.jpg', 0),
(10, '中信银行', 0, 3, 0, './public/bank/10.jpg', 0),
(11, '华夏银行', 0, 3, 0, './public/bank/11.jpg', 0),
(12, '上海浦东发展银行', 0, 3, 1, './public/bank/12.jpg', 0),
(13, '城市信用社', 0, 3, 0, './public/bank/13.jpg', 0),
(14, '恒丰银行', 0, 3, 0, './public/bank/14.jpg', 0),
(15, '广东发展银行', 0, 3, 0, './public/bank/15.jpg', 0),
(16, '深圳发展银行', 0, 3, 2, './public/bank/16.jpg', 0),
(17, '中国民生银行', 0, 3, 0, './public/bank/17.jpg', 0),
(18, '中国农业发展银行', 0, 3, 0, './public/bank/18.jpg', 0),
(19, '农村商业银行', 0, 3, 0, './public/bank/19.jpg', 0),
(20, '农村信用社', 0, 3, 0, './public/bank/20.jpg', 0),
(21, '城市商业银行', 0, 3, 0, './public/bank/21.jpg', 0),
(22, '农村合作银行', 0, 3, 0, './public/bank/22.jpg', 0),
(23, '浙商银行', 0, 3, 0, './public/bank/23.jpg', 0),
(24, '上海农商银行', 0, 3, 0, './public/bank/24.jpg', 0),
(25, '中国进出口银行', 0, 3, 0, './public/bank/25.jpg', 0),
(26, '渤海银行', 0, 3, 0, './public/bank/26.jpg', 0),
(27, '国家开发银行', 0, 3, 0, './public/bank/27.jpg', 0),
(28, '村镇银行', 0, 3, 0, './public/bank/28.jpg', 0),
(29, '徽商银行股份有限公司', 0, 3, 0, './public/bank/29.jpg', 0),
(30, '南洋商业银行', 0, 3, 0, './public/bank/30.jpg', 0),
(31, '韩亚银行', 0, 3, 0, './public/bank/31.jpg', 0),
(32, '花旗银行', 0, 3, 0, './public/bank/32.jpg', 0),
(33, '渣打银行', 0, 3, 0, './public/bank/33.jpg', 0),
(34, '华一银行', 0, 3, 0, './public/bank/34.jpg', 0),
(35, '东亚银行', 1, 3, 0, './public/bank/35.jpg', 0),
(36, '苏格兰皇家银行', 1, 1, 26, './public/bank/36.jpg', 0);
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='// 配置' AUTO_INCREMENT=312 ;

--
-- 转存表中的数据 `%DB_PREFIX%conf`
--

INSERT INTO `%DB_PREFIX%conf` (`id`, `name`, `value`, `group_id`, `input_type`, `value_scope`, `is_effect`, `is_conf`, `sort`) VALUES
...
(20, 'TEMPLATE', '%DB_PREFIX%1', 1, 0, '', 1, 1, 17),
(21, 'SITE_LOGO', './public/attachment/201602/16/17/56c2ea5ce3b23.png', 1, 2, '', 1, 1, 19),
(173, 'SEO_TITLE', '预购一个梦想', 1, 0, '', 1, 1, 20),
(24, 'SMS_ON', '0', 5, 1, '0,1', 1, 1, 78),
(26, 'PUBLIC_DOMAIN_ROOT', '', 2, 0, '', 0, 1, 59),
(27, 'APP_MSG_SENDER_OPEN', '0', 1, 1, '0,1', 1, 1, 9),
(28, 'ADMIN_MSG_SENDER_OPEN', '0', 1, 1, '0,1', 1, 1, 10),
(29, 'GZIP_ON', '0', 1, 1, '0,1', 1, 1, 2),
(42, 'SITE_NAME', '方维众筹', 1, 0, '', 1, 1, 1),
...
(35, 'IMAGE_USERNAME', 'admin', 2, 0, '', 0, 1, 60),
(36, 'IMAGE_PASSWORD', 'admin', 2, 4, '', 0, 1, 61),
(37, 'DEAL_MSG_LOCK', '0', 0, 0, '', 0, 0, 0),
(38, 'SEND_SPAN', '2', 1, 0, '', 1, 1, 85),
(39, 'TMPL_CACHE_ON', '1', 1, 1, '0,1', 1, 1, 6),
(40, 'DOMAIN_ROOT', '', 1, 0, '', 1, 0, 10),
(41, 'COOKIE_PATH', '/', 1, 0, '', 0, 1, 10),
(43, 'INTEGRATE_CFG', '', 0, 0, '', 1, 0, 0),
(44, 'INTEGRATE_CODE', '', 0, 0, '', 1, 0, 0),
(172, 'PAY_RADIO', '0.1', 3, 0, '', 1, 1, 10),
(176, 'SITE_LICENSE', '方维众筹 - fanwe.com 版权所有', 1, 0, '', 1, 1, 22),
(174, 'SEO_KEYWORD', 'SEO关键词', 1, 0, '', 1, 1, 21),
(175, 'SEO_DESCRIPTION', 'SEO描述', 1, 0, '', 1, 1, 22),
(177, 'PROMOTE_MSG_LOCK', '0', 0, 0, '', 0, 0, 0),
(178, 'PROMOTE_MSG_PAGE', '0', 0, 0, '0', 0, 0, 0),
(179, 'STATE_CDOE', '', 1, 0, '', 1, 1, 23),
(180, 'USER_VERIFY', '0', 4, 1, '0,1,2,3,4,5,6', 1, 1, 63),
(181, 'INVITE_REFERRALS', '20', 4, 0, '', 1, 1, 67),
(182, 'INVITE_REFERRALS_TYPE', '1', 4, 1, '0,1', 0, 1, 68),
(183, 'USER_MESSAGE_AUTO_EFFECT', '1', 4, 1, '0,1', 1, 1, 64),
(184, 'BUY_INVITE_REFERRALS', '20', 4, 0, '', 1, 1, 67),
(185, 'REFERRAL_IP_LIMI', '0', 4, 1, '0,1', 1, 1, 71),
(288, 'VIRSUAL_NUM', '0', 4, 0, '', 1, 1, 288),
(190, 'MAIL_SEND_PAYMENT', '0', 5, 1, '0,1', 1, 1, 75),
(191, 'REPLY_ADDRESS', 'info@fanwe.com', 5, 0, '', 1, 1, 77),
(192, 'MAIL_SEND_DELIVERY', '0', 5, 1, '0,1', 1, 1, 76),
(193, 'MAIL_ON', '0', 5, 1, '0,1', 1, 1, 72),
(262, 'NETWORK_FOR_RECORD', '闽ICP备10206706号-7', 1, 0, '', 1, 1, 201),
(263, 'QR_CODE', './public/attachment/201602/16/17/56c2eae468581.jpg', 3, 2, '', 1, 1, 202),
(264, 'REPAY_MAKE', '7', 1, 0, '', 1, 1, 264),
(265, 'SQL_CHECK', '0', 1, 1, '0,1', 1, 1, 265),
(266, 'MORTGAGE_MONEY', '0.01', 6, 0, '', 1, 1, 1),
(267, 'ENQUIER_NUM', '6', 6, 0, '', 1, 1, 2),
(268, 'INVEST_PAY_SEND_STATUS', '1', 5, 1, '0,1,2', 1, 1, 3),
(269, 'INVEST_STATUS_SEND_STATUS', '1', 5, 1, '0,1,2', 1, 1, 4),
(270, 'INVEST_PAID_SEND_STATUS', '1', 5, 1, '0,1,2', 1, 1, 5),
(271, 'INVEST_STATUS', '0', 6, 1, '0,1,2', 1, 1, 0),
(272, 'AVERAGE_USER_STATUS', '1', 6, 1, '0,1', 1, 1, 6),
(186, 'REFERRAL_LIMIT', '1', 4, 0, '', 1, 1, 69),
(273, 'KF_PHONE', '400-000-0000', 3, 0, '', 1, 1, 69),
(274, 'KF_QQ', '1220082698', 3, 0, '', 1, 1, 69),
(275, 'SCORE_TRADE_NUMBER', '100', 4, 0, '', 1, 1, 72),
(276, 'BUY_PRESEND_SCORE_MULTIPLE', '1', 4, 0, '', 1, 1, 72),
(277, 'BUY_PRESEND_POINT_MULTIPLE', '1', 4, 0, '', 1, 1, 72),
(278, 'PROJECT_HIDE', '0', 3, 1, '0,1', 1, 1, 69),
(279, 'WORK_TIME', '09:00-18:30', 3, 0, '', 1, 1, 69),
(280, 'IDENTIFY_POSITIVE', '1', 4, 1, '0,1', 1, 1, 283),
(281, 'IDENTIFY_NAGATIVE', '1', 4, 1, '0,1', 1, 1, 284),
(282, 'BUSINESS_LICENCE', '1', 4, 1, '0,1', 1, 1, 285),
(283, 'BUSINESS_CODE', '1', 4, 1, '0,1', 1, 1, 286),
(284, 'BUSINESS_TAX', '1', 4, 1, '0,1', 1, 1, 287),
(289, 'MORTGAGE_MONEY_UNFREEZE', '12', 6, 0, '', 1, 1, 500),
(290, 'WX_MSG_LOCK', '0', 0, 0, '', 0, 0, 0),
(291, 'USER_VERIFY_STATUS', '1', 4, 1, '0,1', 1, 1, 291),
(292, 'GQ_NAME', '股权众筹', 6, 0, '', 1, 1, 500),
(293, 'PAYPASS_STATUS', '1', 4, 1, '0,1', 1, 1, 293),
(294, 'USER_SEND_VERIFY_TIME', '300', 4, 0, '', 1, 1, 294),
(295, 'URL_NAME', 'm.php', 1, 0, '', 1, 1, 0),
(296, 'IS_SELFLESS', '1', 7, 1, '0,1', 1, 1, 0),
(297, 'IS_ENQUIRY', '1', 6, 1, '0,1', 1, 1, 0),
(298, 'IS_LIMITED_PARTNER', '1', 6, 1, '0,1', 1, 1, 0),
(299, 'IS_FINANCE', '0', 6, 1, '0,1', 1, 1, 0),
(300, 'VOTE_ID', '', 4, 0, '', 1, 1, 0),
(301, 'IS_HOUSE', '0', 7, 1, '0,1', 1, 1, 0),
(302, 'USER_SUBMIT_TIME', '5', 4, 0, '0', 1, 1, 302),
(305, 'BAIDU_MAP_APPKEY', '', 1, 0, '', 1, 1, 265),
(306, 'CREDIT_REPORT', '0', 4, 1, '0,1', 1, 1, 306),
(307, 'HOUSING_CERTIFICATE', '0', 4, 1, '0,1', 1, 1, 307),
(308, 'IS_STOCK_TRANSFER', '1', 6, 1, '0,1', 1, 1, 0),
(309, 'STOCK_TRANSFER_IS_VERIFY', '1', 6, 1, '0,1', 1, 1, 0),
(310, 'STOCK_TRANSFER_COMMISION', '0.1', 6, 0, '', 1, 1, 0),
(311, 'IS_SMS_DIRECT', '0', 5, 1, '0,1', 1, 1, 0);
...
CREATE TABLE IF NOT EXISTS `%DB_PREFIX%deal_cate` (
  ...
  `is_delete` tinyint(1) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='// 项目分类' AUTO_INCREMENT=11 ;

--
-- 转存表中的数据 `%DB_PREFIX%deal_cate`
--

INSERT INTO `%DB_PREFIX%deal_cate` (`id`, `name`, `sort`, `pid`, `is_delete`) VALUES
(1, '设计', 1, 0, 0),
(2, '科技', 2, 0, 0),
(3, '影视', 3, 0, 0),
(4, '摄影', 4, 0, 0),
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='// 项目评论' AUTO_INCREMENT=176 ;

--
-- 转存表中的数据 `%DB_PREFIX%deal_comment`
--

INSERT INTO `%DB_PREFIX%deal_comment` (`id`, `deal_id`, `content`, `user_id`, `create_time`, `log_id`, `user_name`, `pid`, `deal_user_id`, `reply_user_id`, `deal_user_name`, `reply_user_name`, `deal_info_cache`, `status`) VALUES
(170, 55, '加油哦！', 18, 1352229601, 26, 'fzmatthew', 0, 17, 0, 'fanwe', '', '', 0),
(171, 56, '感谢支持！！', 18, 1352230363, 27, 'fzmatthew', 0, 18, 0, 'fzmatthew', '', '', 0),
(172, 57, '好好加油！', 18, 1352230882, 28, 'fzmatthew', 0, 17, 0, 'fanwe', '', '', 0),
(173, 57, '回复 fzmatthew:一定会的。', 17, 1352230924, 28, 'fanwe', 172, 17, 18, 'fanwe', 'fzmatthew', '', 0),
(174, 58, '感谢', 17, 1352231585, 29, 'fanwe', 0, 17, 0, 'fanwe', '', '', 0),
(175, 58, '感谢大家的支持', 17, 1352231787, 0, 'fanwe', 0, 17, 0, 'fanwe', '', '', 0);

-- --------------------------------------------------------

--
-- 表的结构 `%DB_PREFIX%deal_faq`
--
...
CREATE TABLE IF NOT EXISTS `%DB_PREFIX%deal_faq` (
  ...
  KEY `deal_id` (`deal_id`),
  KEY `sort` (`sort`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='//项目常见问题解答' AUTO_INCREMENT=106 ;

--
-- 转存表中的数据 `%DB_PREFIX%deal_faq`
--

INSERT INTO `%DB_PREFIX%deal_faq` (`id`, `deal_id`, `question`, `answer`, `sort`) VALUES
(103, 56, '我们的咖啡馆在哪里？', '目前暂定的店址，是在延安西路、重庆北路附近。', 1),
(104, 56, '我们的咖啡馆大概有多大？', '目前定的店址面积约在200平米以内，有上下两层，底楼较小，二层是整个一层。', 2),
(105, 56, '咖啡馆筹备的进度是？', '由于各种的原因，在寻找店址的过程中，先先后后放弃了很多地方，目前找的店址，在办证、面积、交通等方面都较理想。所以基本确定了地方，正在积极办理营业执照及设计各方面的工作，同时也在现有资金的基础上，募集更多的资金及支持。目前店面的装修免租期约在2个月内，所以离正式开业还需要一些时日。', 3),
(101, 58, '流浪猫与爱天使咖啡是什么关系呢？', '爱天使就是收养救助流浪猫的咖啡馆。因为救助需要资金与空间，这个资金的最好来源一定是要有一个有收益的项目来支撑而非单纯靠募捐方式，否则容易造成依赖与被动，当然其实也因自己个性好强。 在繁殖季爱天使最多一天能收到3-6只的流浪猫，三年间独自一人艰难维持并收养救助两百多只流浪猫，所需空间资金精力全部由我个人维持。', 1),
(102, 58, '新店确定了吗？装修顺利吗？在哪里呢？', '新店终于在几经各方协商后于前日确定于文化艺术中心广场正中间（五一文化广场中间文化宫左边，图书馆对面，大润发楼上正中间）的玻璃房。昨天开始了紧张的重新设计装修中。关于搬店的过程几经周折的磨难苦不堪言。因为新店面积比老店小了，而东西只能先搬过去，而里面要装修所以大柜子都没办法先放进去。里面也已堆满了东西，装修师傅找了五个都不愿意接，因为太多东西很影响装修。东西要一直搬来搬去，现在全部是灰，之后又是一大堆的卫生清洁整理工作，已有很多东西因此受到损坏了。。。新店是转过来了付了一大笔转让费未想因为要重装再装修又要投入两万多的改装费，这笔当时完全忘记预算在内了。。。 不过现在顺利的进入装修重新开业在即。谢谢大家的关注支持！我会让爱天使尽快走回正轨。', 2);

-- --------------------------------------------------------

--
-- 表的结构 `%DB_PREFIX%deal_finance_cate`
--

CREATE TABLE IF NOT EXISTS `%DB_PREFIX%deal_finance_cate` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL,
  `sort` int(11) NOT NULL,
  `pid` int(11) NOT NULL,
  `is_effect` tinyint(1) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='// 融资分类' AUTO_INCREMENT=18 ;

-- --------------------------------------------------------

--
-- 表的结构 `%DB_PREFIX%deal_focus_log`
--
...
CREATE TABLE IF NOT EXISTS `%DB_PREFIX%deal_focus_log` (
  ...
  KEY `user_id` (`user_id`),
  KEY `create_time` (`create_time`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='// 项目焦点' AUTO_INCREMENT=34 ;

--
-- 转存表中的数据 `%DB_PREFIX%deal_focus_log`
--

INSERT INTO `%DB_PREFIX%deal_focus_log` (`id`, `deal_id`, `user_id`, `create_time`) VALUES
(32, 58, 18, 1352231518),
(33, 56, 17, 1352232247);
...
--
-- 表的结构 `%DB_PREFIX%deal_house_cate`
--

CREATE TABLE IF NOT EXISTS `%DB_PREFIX%deal_house_cate` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL,
  `sort` int(11) NOT NULL,
  `pid` int(11) NOT NULL,
  `is_effect` tinyint(1) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='// 众筹买房分类' AUTO_INCREMENT=14 ;

-- --------------------------------------------------------

--
-- 表的结构 `%DB_PREFIX%deal_image`
--

CREATE TABLE IF NOT EXISTS `%DB_PREFIX%deal_image` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `deal_id` int(11) NOT NULL,
  `image` varchar(255) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `deal_id` (`deal_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='//项目图片' AUTO_INCREMENT=66 ;

-- --------------------------------------------------------

--
-- 表的结构 `%DB_PREFIX%deal_info_list`
--

CREATE TABLE IF NOT EXISTS `%DB_PREFIX%deal_info_list` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `%DB_PREFIX%deal_investor_cate`
--

CREATE TABLE IF NOT EXISTS `%DB_PREFIX%deal_investor_cate` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL,
  `sort` int(11) NOT NULL,
  `pid` int(11) NOT NULL,
  `is_effect` tinyint(1) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='// 股权众筹分类' AUTO_INCREMENT=18 ;

-- --------------------------------------------------------

--
-- 表的结构 `%DB_PREFIX%deal_item`
--
...
CREATE TABLE IF NOT EXISTS `%DB_PREFIX%deal_item` (
  ...
  KEY `deal_id` (`deal_id`),
  KEY `price` (`price`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='// 项目回报' AUTO_INCREMENT=33 ;

--
-- 转存表中的数据 `%DB_PREFIX%deal_item`
--

INSERT INTO `%DB_PREFIX%deal_item` (`id`, `deal_id`, `price`, `support_count`, `support_amount`, `description`, `is_delivery`, `delivery_fee`, `is_limit_user`, `limit_user`, `repaid_day`, `virtual_person`, `is_share`, `share_fee`, `type`, `lottery_measure`, `maxbuy`, `lottery_draw_time`) VALUES
(17, 55, '10.00', 0, '0.00', '我们将以平信的方式寄出2款桌游的首发纪念牌，随机赠送部分游戏牌（至少5张）并在游戏说明书中致谢', 1, '0.00', 0, 0, 60, 0, 0, '0.00', 0, 0, 0, 0),
(18, 55, '15.00', 1, '15.00', '我们将回报《黄金密码》1套，赠送首发纪念牌并在游戏说明书中致谢。（邮费另计）', 1, '5.00', 0, 0, 60, 0, 0, '0.00', 0, 0, 0, 0),
(19, 55, '30.00', 0, '0.00', '我们将回报《黄金密码》、《功夫》各1套，赠送首发纪念牌并在游戏说明书中致谢。（邮费另计）', 1, '5.00', 0, 0, 60, 0, 0, '0.00', 0, 0, 0, 0),
(20, 55, '50.00', 0, '0.00', '我们将回报《黄金密码》、《功夫》各2套，赠送首发纪念牌并在游戏说明书中致谢。（邮费另计）', 1, '5.00', 0, 0, 60, 0, 0, '0.00', 0, 0, 0, 0),
(21, 55, '500.00', 0, '0.00', '我们将回报《黄金密码》40套，赠送首发纪念牌并在游戏说明书中致谢，同时还将在首发纪念牌上印上您的姓名或公司名称致谢！（限额2名）。（国内包邮）', 1, '0.00', 0, 0, 60, 0, 0, '0.00', 0, 0, 0, 0),
(22, 56, '50.00', 0, '0.00', '你将收到小组成员，在旅行中为你寄出的一张祝福明信片\r\n你将成为我们开业PARTY的座上嘉宾\r\n所以，请留下你的联系方式（电话，地址及邮编）', 1, '0.00', 0, 0, 50, 0, 0, '0.00', 0, 0, 0, 0),
(23, 56, '200.00', 0, '0.00', '你将获得咖啡馆开业后永久9折会员卡一张（会员卡可用于借阅书籍，并在生日当天获得免费饮料一杯）\r\n店内旅行纪念手信一份（价值在50元以内）\r\n成为开业PARTY的邀请来宾', 1, '0.00', 0, 0, 60, 0, 0, '0.00', 0, 0, 0, 0),
(24, 56, '500.00', 11, '5500.00', '你将获得咖啡馆开业后永久9折会员卡一张（会员卡可用于借阅书籍，并在生日当天获得免费饮料一杯）\r\n一份店内招牌下午茶套餐的招待券\r\n免费参加店内组织的活动（各类分享会、试吃体验等等）\r\n成为开业PARTY的邀请来宾', 1, '0.00', 0, 0, 50, 0, 0, '0.00', 0, 0, 0, 0),
(25, 57, '60.00', 0, '0.00', '电影签名海报和明信片。全国包邮。', 1, '0.00', 0, 0, 50, 0, 0, '0.00', 0, 0, 0, 0),
(26, 57, '150.00', 0, '0.00', '电影DVD的拷贝一张，以及片尾特别感谢。全国包邮。', 1, '0.00', 0, 0, 55, 0, 0, '0.00', 0, 0, 0, 0),
(27, 57, '600.00', 0, '0.00', '一个崭新的印有影片标志的8GB快闪储存器（flash drive), 电影DVD 拷贝，剧照，和特别回报（包括预告片DVD，拍摄花絮DVD）, 以及片尾特别感谢。（所有DVD均有中文字幕），全国包邮。', 1, '0.00', 1, 20, 50, 0, 0, '0.00', 0, 0, 0, 0),
(28, 57, '1200.00', 0, '0.00', '电影签名海报和明信片， 一个崭新的印有影片标志的8GB快闪储存器（flash drive), 电影DVD 拷贝，剧照，和特别回报（包括预告片DVD，拍摄花絮DVD）, 以及片尾特别感谢。（所有DVD均有中文字幕）全国包邮。', 1, '0.00', 1, 5, 10, 0, 0, '0.00', 0, 0, 0, 0),
(29, 57, '3000.00', 0, '0.00', '成为影片的联合制片人（associate producer), 8GB的快闪储存器（flash drive)， 电影DVD 拷贝，剧照，和特别回报（包括预告片DVD，拍摄花絮DVD）。（所有DVD均有中文字幕） 全国包邮。', 1, '0.00', 0, 0, 10, 0, 0, '0.00', 0, 0, 0, 0),
(30, 58, '1000.00', 0, '0.00', '爱的礼物：精美工艺品及红酒。如果你希望得到一份爱的礼物与记念，请留言你的详细地址姓名电话，我将会于爱天使重建之后的三个月内为你寄一件精美的工艺品及价值399元的澳洲红宝龙红酒一瓶！你将成为爱天使的终生会员。。。', 1, '0.00', 0, 0, 50, 0, 0, '0.00', 0, 0, 0, 0),
(31, 58, '2000.00', 1, '2000.00', '爱的礼物：精美工艺品红酒及晚餐。如果你希望得到一份爱的礼物与记念，请留言你的详细地址姓名电话，我将会于爱天使重建之后的三个月内为你寄一件精美的工艺品及澳洲红宝龙红酒一瓶及邀请你到爱天使享受晚餐！你将成为爱天使的终生会员。。。', 1, '0.00', 0, 0, 50, 0, 0, '0.00', 0, 0, 0, 0),
(32, 58, '3000.00', 1, '3000.00', '爱的礼物：精美工艺品及红酒及晚餐。如果你希望得到一份爱的礼物与记念，请留言你的详细地址姓名电话，我将会于爱天使重建之后的三个月内为你寄一件精美的工艺品及价值688元的澳洲康纳瓦拉红酒一瓶及邀请你到爱天使享受晚餐！你将成为爱天使的终生会员。。。', 1, '0.00', 0, 0, 50, 0, 0, '0.00', 0, 0, 0, 0);

-- --------------------------------------------------------

--
-- 表的结构 `%DB_PREFIX%deal_item_image`
--
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='//项目回报图片' AUTO_INCREMENT=59 ;

--
-- 转存表中的数据 `%DB_PREFIX%deal_item_image`
--

INSERT INTO `%DB_PREFIX%deal_item_image` (`id`, `deal_id`, `deal_item_id`, `image`) VALUES
...
--
-- 表的结构 `%DB_PREFIX%deal_level`
--

CREATE TABLE IF NOT EXISTS `%DB_PREFIX%deal_level` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(30) DEFAULT NULL COMMENT '等级名',
  `level` int(11) DEFAULT NULL COMMENT '等级大小   大->小',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='//项目等级' AUTO_INCREMENT=5 ;

-- --------------------------------------------------------

--
-- 表的结构 `%DB_PREFIX%deal_log`
--
...
CREATE TABLE IF NOT EXISTS `%DB_PREFIX%deal_msg_list` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='//私信列表' AUTO_INCREMENT=113 ;

-- --------------------------------------------------------

--
-- 表的结构 `%DB_PREFIX%deal_notify`
--
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='//准备发送通知的项目ID' AUTO_INCREMENT=21 ;
...
CREATE TABLE IF NOT EXISTS `%DB_PREFIX%deal_order` (
  ...
  KEY `deal_item_id` (`deal_item_id`),
  KEY `user_id` (`user_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='// 订单信息' AUTO_INCREMENT=81 ;

--
-- 转存表中的数据 `%DB_PREFIX%deal_order`
--

INSERT INTO `%DB_PREFIX%deal_order` (`id`, `deal_id`, `deal_item_id`, `user_id`, `user_name`, `pay_time`, `total_price`, `delivery_fee`, `deal_price`, `support_memo`, `payment_id`, `bank_id`, `credit_pay`, `online_pay`, `deal_name`, `order_status`, `create_time`, `consignee`, `zip`, `mobile`, `province`, `city`, `address`, `is_success`, `repay_time`, `repay_memo`, `is_refund`, `is_has_send_success`, `repay_make_time`, `num`, `type`, `invest_id`, `share_fee`, `share_status`, `is_tg`, `score`, `score_money`, `sp_multiple`, `logistics_company`, `logistics_links`, `logistics_number`, `requestNo`, `is_complete_transaction`, `fee`, `targetAmount`, `progress`, `is_winner`, `lottery_draw_time`) VALUES
(65, 55, 18, 18, 'fzmatthew', 1352229388, '20.00', '5.00', '15.00', '请在上班时间配送。', 0, 'COMM', '20.00', '0.00', '原创DIY桌面游戏《功夫》《黄金密码》期待您的支持', 3, 1352229388, '方维', '350000', '13333333333', '福建', '福州', '福建福州台江区工业路博美诗邦', 0, 0, '', 0, 0, 0, 1, 0, 0, '0.00', 0, 0, 0, '0.00', '', '', '', '', '', 0, '0.00', '0.00', 0, 0, 00000000000),
(66, 56, 24, 17, 'fanwe', 1352230101, '500.00', '0.00', '500.00', '', 0, '', '500.00', '0.00', '拥有自己的咖啡馆', 3, 1352230101, '方维', '22222', '14444444444', '福建', '福州', '方维方维方维方维方维', 1, 1352230424, '回报已经发货，发货单号123456, 有问题请联系我。', 0, 0, 1424910145, 1, 0, 0, '0.00', 0, 0, 0, '0.00', '', '', '', '', '', 0, '0.00', '0.00', 0, 0, 00000000000),
(67, 56, 24, 19, 'test', 1352230180, '500.00', '0.00', '500.00', '', 24, 'ICBCB2C', '0.00', '500.00', '拥有自己的咖啡馆', 3, 1352230157, 'test', 'test', '13344455555', '湖北', '襄樊', 'test', 1, 0, '', 0, 0, 0, 1, 0, 0, '0.00', 0, 0, 0, '0.00', '', '', '', '', '', 0, '0.00', '0.00', 0, 0, 00000000000),
(68, 56, 24, 19, 'test', 1352230228, '500.00', '0.00', '500.00', '', 0, '', '500.00', '0.00', '拥有自己的咖啡馆', 3, 1352230228, 'test', 'test', '13344455555', '湖北', '襄樊', 'test', 1, 0, '', 0, 0, 0, 1, 0, 0, '0.00', 0, 0, 0, '0.00', '', '', '', '', '', 0, '0.00', '0.00', 0, 0, 00000000000),
(69, 56, 24, 19, 'test', 1352230232, '500.00', '0.00', '500.00', '', 0, '', '500.00', '0.00', '拥有自己的咖啡馆', 3, 1352230232, 'test', 'test', '13344455555', '湖北', '襄樊', 'test', 1, 0, '', 0, 0, 0, 1, 0, 0, '0.00', 0, 0, 0, '0.00', '', '', '', '', '', 0, '0.00', '0.00', 0, 0, 00000000000),
(70, 56, 24, 19, 'test', 1352230237, '500.00', '0.00', '500.00', '', 0, '', '500.00', '0.00', '拥有自己的咖啡馆', 3, 1352230237, 'test', 'test', '13344455555', '湖北', '襄樊', 'test', 1, 0, '', 0, 0, 0, 1, 0, 0, '0.00', 0, 0, 0, '0.00', '', '', '', '', '', 0, '0.00', '0.00', 0, 0, 00000000000),
(71, 56, 24, 19, 'test', 1352230240, '500.00', '0.00', '500.00', '', 0, '', '500.00', '0.00', '拥有自己的咖啡馆', 3, 1352230240, 'test', 'test', '13344455555', '湖北', '襄樊', 'test', 1, 0, '', 0, 0, 0, 1, 0, 0, '0.00', 0, 0, 0, '0.00', '', '', '', '', '', 0, '0.00', '0.00', 0, 0, 00000000000),
(72, 56, 24, 19, 'test', 1352230243, '500.00', '0.00', '500.00', '', 0, '', '500.00', '0.00', '拥有自己的咖啡馆', 3, 1352230243, 'test', 'test', '13344455555', '湖北', '襄樊', 'test', 1, 0, '', 0, 0, 0, 1, 0, 0, '0.00', 0, 0, 0, '0.00', '', '', '', '', '', 0, '0.00', '0.00', 0, 0, 00000000000),
(73, 56, 24, 19, 'test', 1352230247, '500.00', '0.00', '500.00', '', 0, '', '500.00', '0.00', '拥有自己的咖啡馆', 3, 1352230247, 'test', 'test', '13344455555', '湖北', '襄樊', 'test', 1, 0, '', 0, 0, 0, 1, 0, 0, '0.00', 0, 0, 0, '0.00', '', '', '', '', '', 0, '0.00', '0.00', 0, 0, 00000000000),
(74, 56, 24, 19, 'test', 1352230268, '500.00', '0.00', '500.00', '', 0, '', '500.00', '0.00', '拥有自己的咖啡馆', 3, 1352230268, 'test', 'test', '13344455555', '湖北', '襄樊', 'test', 1, 0, '', 0, 0, 0, 1, 0, 0, '0.00', 0, 0, 0, '0.00', '', '', '', '', '', 0, '0.00', '0.00', 0, 0, 00000000000),
(75, 56, 24, 19, 'test', 1352230270, '500.00', '0.00', '500.00', '', 0, '', '500.00', '0.00', '拥有自己的咖啡馆', 3, 1352230270, 'test', 'test', '13344455555', '湖北', '襄樊', 'test', 1, 0, '', 0, 0, 0, 1, 0, 0, '0.00', 0, 0, 0, '0.00', '', '', '', '', '', 0, '0.00', '0.00', 0, 0, 00000000000),
(76, 56, 24, 19, 'test', 1352230293, '500.00', '0.00', '500.00', '', 0, '', '500.00', '0.00', '拥有自己的咖啡馆', 3, 1352230293, 'test', 'test', '13344455555', '湖北', '襄樊', 'test', 1, 0, '', 0, 0, 0, 1, 0, 0, '0.00', 0, 0, 0, '0.00', '', '', '', '', '', 0, '0.00', '0.00', 0, 0, 00000000000),
(77, 58, 31, 18, 'fzmatthew', 1352231539, '2000.00', '0.00', '2000.00', 'test', 0, '', '2000.00', '0.00', '流浪猫的家—爱天使公益咖啡馆的重建需要大家的力量！', 3, 1352231539, '方维', '350000', '13333333333', '福建', '福州', '福建福州台江区工业路博美诗邦', 1, 0, '', 0, 0, 0, 1, 0, 0, '0.00', 0, 0, 0, '0.00', '', '', '', '', '', 0, '0.00', '0.00', 0, 0, 00000000000),
(78, 58, 30, 19, 'test', 0, '1000.00', '0.00', '1000.00', 'ttt', 24, 'CCB', '500.00', '0.00', '流浪猫的家—爱天使公益咖啡馆的重建需要大家的力量！', 0, 1352231631, 'test', 'test', '13344455555', '湖北', '襄樊', 'test', 1, 0, '', 0, 0, 0, 1, 0, 0, '0.00', 0, 0, 0, '0.00', '', '', '', '', '', 0, '0.00', '0.00', 0, 0, 00000000000),
(79, 56, 24, 17, 'fanwe', 0, '500.00', '0.00', '500.00', '部份支付', 24, 'ICBCB2C', '300.00', '0.00', '拥有自己的咖啡馆', 0, 1352231671, '方维', '22222', '14444444444', '福建', '福州', '方维方维方维方维方维', 1, 0, '', 0, 0, 0, 1, 0, 0, '0.00', 0, 0, 0, '0.00', '', '', '', '', '', 0, '0.00', '0.00', 0, 0, 00000000000),
(80, 58, 32, 18, 'fzmatthew', 1352231704, '3000.00', '0.00', '3000.00', '', 0, '', '3000.00', '0.00', '流浪猫的家—爱天使公益咖啡馆的重建需要大家的力量！', 3, 1352231704, '方维', '350000', '13333333333', '福建', '福州', '福建福州台江区工业路博美诗邦', 1, 0, '', 0, 0, 0, 1, 0, 0, '0.00', 0, 0, 0, '0.00', '', '', '', '', '', 0, '0.00', '0.00', 0, 0, 00000000000);

-- --------------------------------------------------------

--
-- 表的结构 `%DB_PREFIX%deal_order_lottery`
--

CREATE TABLE IF NOT EXISTS `%DB_PREFIX%deal_order_lottery` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `deal_id` int(11) NOT NULL COMMENT '项目id',
...
CREATE TABLE IF NOT EXISTS `%DB_PREFIX%deal_pay_log` (
  ...
  KEY `deal_id` (`deal_id`),
  KEY `create_time` (`create_time`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='//项目支持金额发放记录' AUTO_INCREMENT=4 ;

-- --------------------------------------------------------

--
-- 表的结构 `%DB_PREFIX%deal_selfless_cate`
--

CREATE TABLE IF NOT EXISTS `%DB_PREFIX%deal_selfless_cate` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL,
  `sort` int(11) NOT NULL,
  `pid` int(11) NOT NULL,
  `is_effect` tinyint(1) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='// 公益众筹分类' AUTO_INCREMENT=18 ;

-- --------------------------------------------------------

--
-- 表的结构 `%DB_PREFIX%deal_support_log`
--
...
CREATE TABLE IF NOT EXISTS `%DB_PREFIX%deal_support_log` (
  ...
  KEY `create_time` (`create_time`),
  KEY `deal_item_id` (`deal_item_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='// 项目支持记录' AUTO_INCREMENT=55 ;

--
-- 转存表中的数据 `%DB_PREFIX%deal_support_log`
--

INSERT INTO `%DB_PREFIX%deal_support_log` (`id`, `deal_id`, `user_id`, `create_time`, `price`, `deal_item_id`, `num`) VALUES
(41, 55, 18, 1352229388, '15.00', 18, 1),
(42, 56, 17, 1352230101, '500.00', 24, 1),
(43, 56, 19, 1352230180, '500.00', 24, 1),
(44, 56, 19, 1352230228, '500.00', 24, 1),
(45, 56, 19, 1352230232, '500.00', 24, 1),
(46, 56, 19, 1352230237, '500.00', 24, 1),
(47, 56, 19, 1352230240, '500.00', 24, 1),
(48, 56, 19, 1352230243, '500.00', 24, 1),
(49, 56, 19, 1352230247, '500.00', 24, 1),
(50, 56, 19, 1352230268, '500.00', 24, 1),
(51, 56, 19, 1352230270, '500.00', 24, 1),
(52, 56, 19, 1352230293, '500.00', 24, 1),
(53, 58, 18, 1352231539, '2000.00', 31, 1),
(54, 58, 18, 1352231704, '3000.00', 32, 1);

-- --------------------------------------------------------

--
-- 表的结构 `%DB_PREFIX%deal_visit_log`
--
...
CREATE TABLE IF NOT EXISTS `%DB_PREFIX%deal_visit_log` (
  ...
  PRIMARY KEY (`id`),
  KEY `deal_id` (`deal_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='// 访问记录' AUTO_INCREMENT=134 ;

--
-- 转存表中的数据 `%DB_PREFIX%deal_visit_log`
--

INSERT INTO `%DB_PREFIX%deal_visit_log` (`id`, `deal_id`, `client_ip`, `create_time`) VALUES
...
(130, 58, '127.0.0.1', 1455586010),
(131, 56, '127.0.0.1', 1455586205),
(132, 57, '127.0.0.1', 1455586417),
(133, 58, '127.0.0.1', 1455586732);

-- --------------------------------------------------------

--
-- 表的结构 `%DB_PREFIX%deal_vote`
--

CREATE TABLE IF NOT EXISTS `%DB_PREFIX%deal_vote` (
...
--
-- 表的结构 `%DB_PREFIX%deal_vote_log`
--

CREATE TABLE IF NOT EXISTS `%DB_PREFIX%deal_vote_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'id',
...
CREATE TABLE IF NOT EXISTS `%DB_PREFIX%faq` (
  ...
  KEY `sort` (`sort`),
  KEY `group` (`group`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='// 常见问题设置' AUTO_INCREMENT=22 ;

--
-- 转存表中的数据 `%DB_PREFIX%faq`
--

INSERT INTO `%DB_PREFIX%faq` (`id`, `group`, `question`, `answer`, `sort`) VALUES
...
--
-- 表的结构 `%DB_PREFIX%file_verifies`
--

CREATE TABLE IF NOT EXISTS `%DB_PREFIX%file_verifies` (
...
--
-- 表的结构 `%DB_PREFIX%finance_company`
--

CREATE TABLE IF NOT EXISTS `%DB_PREFIX%finance_company` (
...
--
-- 表的结构 `%DB_PREFIX%finance_company_focus`
--

CREATE TABLE IF NOT EXISTS `%DB_PREFIX%finance_company_focus` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `company_id` int(11) NOT NULL COMMENT '融资公司ID',
  `user_id` int(11) NOT NULL,
  `create_time` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='关注的公司' AUTO_INCREMENT=3 ;

-- --------------------------------------------------------

--
-- 表的结构 `%DB_PREFIX%finance_company_investment_case`
--

CREATE TABLE IF NOT EXISTS `%DB_PREFIX%finance_company_investment_case` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `company_id` int(11) NOT NULL COMMENT '融资公司ID',
  `create_time` int(11) NOT NULL,
  `company_name` varchar(255) NOT NULL COMMENT '公司简称',
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='关注的公司' AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- 表的结构 `%DB_PREFIX%finance_company_sub_product`
--

CREATE TABLE IF NOT EXISTS `%DB_PREFIX%finance_company_sub_product` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `company_id` int(11) NOT NULL COMMENT '融资公司ID',
  `create_time` int(11) NOT NULL,
  ...
  `status` tinyint(1) NOT NULL COMMENT '0 未审核 1审核通过 2 审核不通过',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='公司的子产品' AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- 表的结构 `%DB_PREFIX%finance_company_team`
--

CREATE TABLE IF NOT EXISTS `%DB_PREFIX%finance_company_team` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='公司团队' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `%DB_PREFIX%help` (
  ...
  PRIMARY KEY (`id`),
  KEY `sort` (`sort`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='// 帮助介绍' AUTO_INCREMENT=8 ;

--
-- 转存表中的数据 `%DB_PREFIX%help`
--

INSERT INTO `%DB_PREFIX%help` (`id`, `title`, `content`, `type`, `url`, `is_fix`, `sort`) VALUES
...
(3, '隐私策略', '', 'privacy', '', 1, 1),
(4, '关于我们', '', 'about', '', 1, 1),
(5, '官方微博', 'adsfadsfasdf', '', 'http://weibo.com/fzmatthew', 0, 1),
(7, '撰写指南', '', 'write_guide', '', 1, 1);

-- --------------------------------------------------------

--
-- 表的结构 `%DB_PREFIX%index_image`
--
...
CREATE TABLE IF NOT EXISTS `%DB_PREFIX%index_image` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='//首页图片' AUTO_INCREMENT=7 ;

--
-- 转存表中的数据 `%DB_PREFIX%index_image`
--

INSERT INTO `%DB_PREFIX%index_image` (`id`, `image`, `url`, `sort`, `title`, `type`) VALUES
(5, './public/attachment/201211/07/10/5099c97ad9f82.gif', 'http://zc.fanwe.cn', 1, '方维众筹', 0),
(6, './public/attachment/201211/07/10/5099c984946c3.jpg', 'http://zc.fanwe.cn', 2, '方维众筹', 0);

-- --------------------------------------------------------

--
-- 表的结构 `%DB_PREFIX%investment_list`
--

CREATE TABLE IF NOT EXISTS `%DB_PREFIX%investment_list` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `%DB_PREFIX%invite`
--

CREATE TABLE IF NOT EXISTS `%DB_PREFIX%invite` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `job_end_time` int(11) NOT NULL DEFAULT '0' COMMENT '0 表示至今 ',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='邀请列表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `%DB_PREFIX%licai_fund_type` (
  ...
  `sort` int(10) NOT NULL DEFAULT '0' COMMENT '排序',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='基金种类：\r\n全部 货币型 股票型 债券型 混合型 理财型 指数型 QDII 其他型' AUTO_INCREMENT=11 ;
...
CREATE TABLE IF NOT EXISTS `%DB_PREFIX%licai_interest` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='利率列表【不同投资金额，可以获得不同的利率】' AUTO_INCREMENT=51 ;
...
CREATE TABLE IF NOT EXISTS `%DB_PREFIX%licai_order` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='理财订单表' AUTO_INCREMENT=147 ;
...
CREATE TABLE IF NOT EXISTS `%DB_PREFIX%licai_recommend` (
  ...
  `sort` int(10) NOT NULL DEFAULT '0' COMMENT '排序',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='个性推荐' AUTO_INCREMENT=10 ;
...
CREATE TABLE IF NOT EXISTS `%DB_PREFIX%link` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='//链接' AUTO_INCREMENT=128 ;
...
CREATE TABLE IF NOT EXISTS `%DB_PREFIX%link_group` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='//链接组' AUTO_INCREMENT=18 ;

--
-- 转存表中的数据 `%DB_PREFIX%link_group`
--

INSERT INTO `%DB_PREFIX%link_group` (`id`, `name`, `sort`, `is_effect`, `type`) VALUES
(14, '友情链接', 1, 1, 0);
...
CREATE TABLE IF NOT EXISTS `%DB_PREFIX%log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='//记录' AUTO_INCREMENT=2442 ;
...
(2380, '发起项目更新成功', 1417975607, 1, '127.0.0.1', 1, 'Article', 'update'),
(2381, 'TPL_MAIL_INVESTOR_PAY_STATUS更新成功', 1422475811, 1, '127.0.0.1', 1, 'MsgTemplate', 'update'),
(2382, 'admin登录成功', 1434136365, 1, '127.0.0.1', 1, 'Public', 'do_login'),
(2383, '我有项目更新成功', 1434136446, 1, '127.0.0.1', 1, 'ArticleCate', 'update'),
(2384, '合作方式更新成功', 1434136453, 1, '127.0.0.1', 1, 'ArticleCate', 'update'),
(2385, '媒体报道更新成功', 1434136459, 1, '127.0.0.1', 1, 'ArticleCate', 'update'),
(2386, '活动报名更新成功', 1434136466, 1, '127.0.0.1', 1, 'ArticleCate', 'update'),
(2387, '新手帮助更新成功', 1434136474, 1, '127.0.0.1', 1, 'ArticleCate', 'update'),
(2388, '关于我们更新成功', 1434136480, 1, '127.0.0.1', 1, 'ArticleCate', 'update'),
(2389, '站点申明更新成功', 1434136488, 1, '127.0.0.1', 1, 'ArticleCate', 'update'),
(2390, '发起项目更新成功', 1434136507, 1, '127.0.0.1', 1, 'Article', 'update'),
(2391, '会员注册更新成功', 1434136523, 1, '127.0.0.1', 1, 'Article', 'update'),
(2392, '版权申明更新成功', 1434136537, 1, '127.0.0.1', 1, 'Article', 'update'),
(2393, '项目规范更新成功', 1434136547, 1, '127.0.0.1', 1, 'Article', 'update'),
(2394, '【媒体报道】众筹平台助“印象”打造专业川菜连锁品牌更新成功', 1434136558, 1, '127.0.0.1', 1, 'Article', 'update'),
(2395, '使用条款更新成功', 1434136572, 1, '127.0.0.1', 1, 'Article', 'update'),
(2396, '【活动报名】10.21第一期天使合投SHOW热辣登场！更新成功', 1434136582, 1, '127.0.0.1', 1, 'Article', 'update'),
(2397, '常见问题更新成功', 1434136594, 1, '127.0.0.1', 1, 'Article', 'update'),
(2398, '联系方式更新成功', 1434136603, 1, '127.0.0.1', 1, 'Article', 'update'),
(2399, '关于我们更新成功', 1434136614, 1, '127.0.0.1', 1, 'Article', 'update'),
(2400, '流浪猫的家—爱天使公益咖啡馆的重建需要大家的力量！更新成功', 1434136659, 1, '127.0.0.1', 1, 'Deal', 'update'),
(2401, '短片电影《Blind Love》更新成功', 1434136671, 1, '127.0.0.1', 1, 'Deal', 'update'),
(2402, '拥有自己的咖啡馆更新成功', 1434136682, 1, '127.0.0.1', 1, 'Deal', 'update'),
(2403, '原创DIY桌面游戏《功夫》《黄金密码》期待您的支持更新成功', 1434136697, 1, '127.0.0.1', 1, 'Deal', 'update'),
(2404, '58_is_special启用成功', 1434136705, 1, '127.0.0.1', 1, 'Deal', 'toogle_status'),
(2405, '56_is_special启用成功', 1434136708, 1, '127.0.0.1', 1, 'Deal', 'toogle_status'),
(2406, 'admin登录成功', 1438559152, 1, '127.0.0.1', 1, 'Public', 'do_login'),
(2407, 'admin登录成功', 1450915035, 1, '127.0.0.1', 1, 'Public', 'do_login'),
(2408, 'admin登录成功', 1453143765, 1, '::1', 1, 'Public', 'do_login'),
(2409, '测试管理员更新成功', 1453143872, 1, '::1', 1, 'Role', 'update'),
(2410, '测试管理员更新成功', 1453143896, 1, '::1', 1, 'Role', 'update'),
(2411, '更新系统配置', 1453144048, 1, '::1', 1, 'Conf', 'update'),
(2412, '测试管理员更新成功', 1453144423, 1, '::1', 1, 'Role', 'update'),
(2413, '测试管理员更新成功', 1453144510, 1, '::1', 1, 'Role', 'update'),
(2414, '测试管理员更新成功', 1453145592, 1, '::1', 1, 'Role', 'update'),
(2415, 'test添加成功', 1453145611, 1, '::1', 1, 'Admin', 'insert'),
(2416, 'test登录成功', 1453145662, 4, '::1', 1, 'Public', 'do_login'),
(2417, '测试管理员更新成功', 1453145703, 1, '::1', 1, 'Role', 'update'),
(2418, '更新系统配置', 1455585763, 1, '127.0.0.1', 1, 'Conf', 'update'),
(2419, '更新系统配置', 1455585785, 1, '127.0.0.1', 1, 'Conf', 'update'),
(2420, '更新系统配置', 1455585798, 1, '127.0.0.1', 1, 'Conf', 'update'),
(2421, '更新系统配置', 1455585864, 1, '127.0.0.1', 1, 'Conf', 'update'),
(2422, '更新系统配置', 1455585895, 1, '127.0.0.1', 1, 'Conf', 'update'),
(2423, '所有项目更新成功', 1455586841, 1, '127.0.0.1', 1, 'Nav', 'update'),
(2424, '产品众筹更新成功', 1455586862, 1, '127.0.0.1', 1, 'Nav', 'update'),
(2425, '公益模块更新成功', 1455586877, 1, '127.0.0.1', 1, 'Nav', 'update'),
(2426, '股权众筹更新成功', 1455586942, 1, '127.0.0.1', 1, 'Nav', 'update'),
(2427, '经典项目更新成功', 1455586973, 1, '127.0.0.1', 1, 'Nav', 'update'),
(2428, '股权交易添加成功', 1455587010, 1, '127.0.0.1', 1, 'Nav', 'insert'),
(2429, '积分商城添加成功', 1455587152, 1, '127.0.0.1', 1, 'Nav', 'insert'),
(2430, '动态最新添加成功', 1455587166, 1, '127.0.0.1', 1, 'Nav', 'insert'),
(2431, '动态最新彻底删除成功', 1455587206, 1, '127.0.0.1', 1, 'Nav', 'foreverdelete'),
(2432, '新手帮助添加成功', 1455587237, 1, '127.0.0.1', 1, 'Nav', 'insert'),
(2433, '天使投资人添加成功', 1455587292, 1, '127.0.0.1', 1, 'Nav', 'insert'),
(2434, '股权交易排序修改成功', 1455587352, 1, '127.0.0.1', 1, 'Nav', 'set_sort'),
(2435, '文章更新成功', 1455587390, 1, '127.0.0.1', 1, 'Nav', 'update'),
(2436, '路演资讯排序修改成功', 1455587417, 1, '127.0.0.1', 1, 'Nav', 'set_sort'),
(2437, '积分商城排序修改成功', 1455587421, 1, '127.0.0.1', 1, 'Nav', 'set_sort'),
(2438, '天使投资人排序修改成功', 1455587424, 1, '127.0.0.1', 1, 'Nav', 'set_sort'),
(2439, '新手帮助排序修改成功', 1455587431, 1, '127.0.0.1', 1, 'Nav', 'set_sort'),
(2440, '最新动态排序修改成功', 1455587431, 1, '127.0.0.1', 1, 'Nav', 'set_sort'),
(2441, '最新动态排序修改成功', 1455587437, 1, '127.0.0.1', 1, 'Nav', 'set_sort');
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='//邮件列表' AUTO_INCREMENT=10 ;
...
CREATE TABLE IF NOT EXISTS `%DB_PREFIX%mail_server` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='// 邮件服务器' AUTO_INCREMENT=8 ;
...
CREATE TABLE IF NOT EXISTS `%DB_PREFIX%message` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='// 用户留言' AUTO_INCREMENT=112 ;

-- --------------------------------------------------------

--
-- 表的结构 `%DB_PREFIX%message_cate`
--

CREATE TABLE IF NOT EXISTS `%DB_PREFIX%message_cate` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `cate_name` varchar(255) NOT NULL,
  `is_project` tinyint(1) NOT NULL DEFAULT '0' COMMENT '项目发起的分类 0表示否 1表示 是',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='// 用户留言分类' AUTO_INCREMENT=3 ;

--
-- 转存表中的数据 `%DB_PREFIX%message_cate`
--

INSERT INTO `%DB_PREFIX%message_cate` (`id`, `cate_name`, `is_project`) VALUES
(1, '项目登记', 1),
(2, '建议留言', 0);
...
CREATE TABLE IF NOT EXISTS `%DB_PREFIX%mobile_verify_code` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='//手机验证' AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- 表的结构 `%DB_PREFIX%money_freeze`
--

CREATE TABLE IF NOT EXISTS `%DB_PREFIX%money_freeze` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
(1, '普通的', 0, 'money', 0, 1),
(2, '加入诚意金', 1, 'money', 0, 1),
(3, '违约扣除诚意金', 2, 'money', 0, 1),
(4, '分红', 3, 'money', 0, 1),
(5, '订金', 4, 'money', 0, 1),
(6, '首付', 5, 'money', 0, 1),
(7, '众筹买房', 6, 'money', 0, 1),
(8, '买房卖出回报', 7, 'money', 0, 1),
(9, '理财赎回本金', 8, 'money', 0, 1),
(10, '理财赎回收益', 9, 'money', 0, 1),
(11, '理财赎回手续费', 10, 'money', 0, 1),
(12, '理财本金', 11, 'money', 0, 1),
(13, '理财购买手续费', 12, 'money', 0, 1),
(14, '理财冻结资金', 13, 'money', 0, 1),
(15, '理财服务费', 14, 'money', 0, 1),
(16, '理财发放资金', 15, 'money', 0, 1);

-- --------------------------------------------------------

--
-- 表的结构 `%DB_PREFIX%mortgate`
--

CREATE TABLE IF NOT EXISTS `%DB_PREFIX%mortgate` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL COMMENT '会员ID',
...
CREATE TABLE IF NOT EXISTS `%DB_PREFIX%msg_template` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='// 邮箱验证' AUTO_INCREMENT=32 ;
...
(20, '171', '', 'deal', 1, '216', 12, 1, 0),
(22, '百度广告', 'http://www.baidu.com/img/bd_logo.png', 'top', 2, 'http://www.baidu.com', 14, 0, 0),
(13, '享客来1', '', 'deal', 1, '135', 5, 1, 0),
(11, '手机广告', './public/attachment/201203/03/09/4f5175debd973.jpg', 'top', 2, 'http://www.baidu.com', 4, 0, 0),
(21, 'test', './public/attachment/201408/14/14/53ec52560a0cd.jpg', 'top', 2, 'http://www.baidu.com', 13, 1, 0),
(19, '108', '', 'deal', 1, '108', 11, 1, 0),
(23, '平整占2', '', 'top', 1, '1', 15, 0, 0),
(17, '首页广告测试刷新功能', './public/attachment/201407/30/09/53d84720ecff4.jpg', 'top', 2, 'http://www.baidu.com', 9, 1, 0),
(18, '信贷的测试2', './public/attachment/201407/29/15/53d752859c703.jpg', 'top', 2, 'http://www.baidu.com', 10, 1, 0);
...
INSERT INTO `%DB_PREFIX%m_config` (`id`, `code`, `title`, `val`, `type`, `sort`, `value_scope`) VALUES
(10, 'kf_phone', '客服电话', '', 0, 1, NULL),
(11, 'kf_email', '客服邮箱', '', 0, 2, NULL),
(29, 'ios_upgrade', 'ios版本升级内容', '', 3, 9, NULL),
(16, 'page_size', '分页大小', '10', 0, 10, NULL),
(17, 'about_info', '关于我们(填文章ID)', '', 0, 3, NULL),
(18, 'program_title', '程序标题名称', '', 0, 0, NULL),
(22, 'android_version', 'android版本号(yyyymmddnn)', '', 0, 4, NULL),
(23, 'android_filename', 'android下载包名(放程序根目录下)', '', 0, 5, NULL),
(24, 'ios_version', 'ios版本号(yyyymmddnn)', '', 0, 7, NULL),
(25, 'ios_down_url', 'ios下载地址(appstore连接地址)', '', 0, 8, NULL),
(28, 'android_upgrade', 'android版本升级内容', '修复bug', 3, 6, NULL),
(30, 'article_cate_id', '文章分类ID', '', 0, 11, NULL),
(31, 'android_forced_upgrade', 'android是否强制升级(0:否;1:是)', '1', 0, 0, NULL),
(32, 'ios_forced_upgrade', 'ios是否强制升级(0:否;1:是)', '1', 0, 0, NULL),
(35, 'logo', '系统LOGO', '', 2, 1, NULL),
(33, 'index_adv_num', '首页广告数', '5', 0, 33, NULL),
(34, 'index_pro_num', '首页推荐商品数', '0', 0, 34, NULL),
(36, 'wx_appid', '微信APPID', '', 0, 36, NULL),
(37, 'wx_secrit', '微信SECRIT', '', 0, 37, NULL),
(38, 'sina_app_key', '新浪APP_KEY', NULL, 0, 38, NULL),
(39, 'sina_app_secret', '新浪APP_SECRET', NULL, 0, 39, NULL),
(40, 'sina_bind_url', '新浪回调地址', NULL, 0, 40, NULL),
(41, 'qq_app_key', 'QQ登录APP_KEY', NULL, 0, 41, NULL),
(42, 'qq_app_secret', 'QQ登录APP_SECRET', NULL, 0, 42, NULL),
(43, 'wx_app_key', '微信(分享)appkey', NULL, 0, 43, NULL),
(44, 'wx_app_secret', '微信(分享)appSecret', NULL, 0, 44, NULL),
(45, 'wx_controll', '一站式登录方式', '0', 4, 45, '0,1'),
(46, 'ios_check_version', 'ios审核版本号(审核中填写)', '', 0, 9, '');
...
CREATE TABLE IF NOT EXISTS `%DB_PREFIX%nav` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='//导航菜单列表' AUTO_INCREMENT=55 ;

--
-- 转存表中的数据 `%DB_PREFIX%nav`
--

INSERT INTO `%DB_PREFIX%nav` (`id`, `name`, `url`, `blank`, `sort`, `is_effect`, `u_module`, `u_action`, `u_id`, `u_param`) VALUES
(42, '首页', '', 0, 1, 1, 'index', '', 0, ''),
(47, '公益模块', '', 0, 3, 1, 'deals', 'selfless', 0, ''),
(46, '产品众筹', '', 0, 2, 1, 'deals', 'index', 0, ''),
(48, '最新动态', '', 0, 8, 1, 'news', 'index', 0, ''),
(49, '路演资讯', '', 0, 20, 1, 'article_cate', '', 0, ''),
(50, '股权交易', '', 0, 3, 1, 'deals', 'stock', 0, ''),
(51, '积分商城', '', 0, 5, 1, 'score_mall', '', 0, ''),
(53, '新手帮助', '', 0, 7, 1, 'faq', '', 0, ''),
(54, '天使投资人', '', 0, 6, 1, 'investor', 'invester_list', 0, '');
...
CREATE TABLE IF NOT EXISTS `%DB_PREFIX%payment` (
  ...
  `sort` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='// 付款' AUTO_INCREMENT=25 ;

--
-- 转存表中的数据 `%DB_PREFIX%payment`
--

INSERT INTO `%DB_PREFIX%payment` (`id`, `class_name`, `is_effect`, `online_pay`, `name`, `description`, `total_amount`, `config`, `logo`, `sort`) VALUES
(24, 'AlipayBank', 1, 1, '支付宝银行直连支付', '', '0.00', 'a:4:{s:14:"alipay_partner";s:0:"";s:14:"alipay_account";s:0:"";s:10:"alipay_key";s:0:"";s:14:"alipay_gateway";a:17:{s:7:"ICBCB2C";s:1:"1";s:3:"CMB";s:1:"1";s:3:"CCB";s:1:"1";s:3:"ABC";s:1:"1";s:4:"SPDB";s:1:"1";s:3:"SDB";s:1:"1";s:3:"CIB";s:1:"1";s:6:"BJBANK";s:1:"1";s:7:"CEBBANK";s:1:"1";s:4:"CMBC";s:1:"1";s:5:"CITIC";s:1:"1";s:3:"GDB";s:1:"1";s:7:"SPABANK";s:1:"1";s:6:"BOCB2C";s:1:"1";s:4:"COMM";s:1:"1";s:7:"ICBCBTB";s:1:"1";s:10:"PSBC-DEBIT";s:1:"1";}}', '', 1);
...
CREATE TABLE IF NOT EXISTS `%DB_PREFIX%payment_notice` (
  ...
  KEY `deal_id` (`deal_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='// 付款单号列表' AUTO_INCREMENT=204 ;

--
-- 转存表中的数据 `%DB_PREFIX%payment_notice`
--

INSERT INTO `%DB_PREFIX%payment_notice` (`id`, `notice_sn`, `create_time`, `pay_time`, `order_id`, `is_paid`, `user_id`, `payment_id`, `bank_id`, `memo`, `money`, `outer_notice_sn`, `deal_id`, `deal_item_id`, `deal_name`, `is_has_send_success`, `is_mortgate`, `paid_send`) VALUES
(200, '20121107399', 1352230157, 0, 67, 0, 19, 24, 'ICBCB2C', '', '500.00', '', 56, 24, '拥有自己的咖啡馆', 0, 0, 0),
(201, '20121107985', 1352230180, 1352230180, 67, 1, 19, 0, '', '管理员收款', '500.00', '', 56, 24, '拥有自己的咖啡馆', 0, 0, 0),
(202, '20121107931', 1352231631, 0, 78, 0, 19, 24, 'CCB', 'ttt', '500.00', '', 58, 30, '流浪猫的家—爱天使公益咖啡馆的重建需要大家的力量！', 0, 0, 0),
(203, '20121107124', 1352231671, 0, 79, 0, 17, 24, 'ICBCB2C', '部份支付', '200.00', '', 56, 24, '拥有自己的咖啡馆', 0, 0, 0);
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='// 推广信息' AUTO_INCREMENT=13 ;
...
CREATE TABLE IF NOT EXISTS `%DB_PREFIX%promote_msg_list` (
  ...
  PRIMARY KEY (`id`),
  KEY `dest_idx` (`dest`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='// 推广信息队列表' AUTO_INCREMENT=30 ;

-- --------------------------------------------------------

--
-- 表的结构 `%DB_PREFIX%recommend`
--

CREATE TABLE IF NOT EXISTS `%DB_PREFIX%recommend` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `%DB_PREFIX%region_conf` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='//地区配置' AUTO_INCREMENT=3401 ;

--
-- 转存表中的数据 `%DB_PREFIX%region_conf`
--

INSERT INTO `%DB_PREFIX%region_conf` (`id`, `pid`, `name`, `region_level`, `py`, `is_hot`) VALUES
(3, 1, '安徽', 2, 'anhui', 0),
(4, 1, '福建', 2, 'fujian', 0),
(5, 1, '甘肃', 2, 'gansu', 0),
(6, 1, '广东', 2, 'guangdong', 0),
(7, 1, '广西', 2, 'guangxi', 0),
(8, 1, '贵州', 2, 'guizhou', 0),
(9, 1, '海南', 2, 'hainan', 0),
(10, 1, '河北', 2, 'hebei', 0),
(11, 1, '河南', 2, 'henan', 0),
(12, 1, '黑龙江', 2, 'heilongjiang', 0),
(13, 1, '湖北', 2, 'hubei', 0),
(14, 1, '湖南', 2, 'hunan', 0),
(15, 1, '吉林', 2, 'jilin', 0),
(16, 1, '江苏', 2, 'jiangsu', 0),
(17, 1, '江西', 2, 'jiangxi', 0),
(18, 1, '辽宁', 2, 'liaoning', 0),
(19, 1, '内蒙古', 2, 'neimenggu', 0),
(20, 1, '宁夏', 2, 'ningxia', 0),
(21, 1, '青海', 2, 'qinghai', 0),
(22, 1, '山东', 2, 'shandong', 0),
(23, 1, '山西', 2, 'shanxi', 0),
(24, 1, '陕西', 2, 'shanxi', 0),
(26, 1, '四川', 2, 'sichuan', 0),
(28, 1, '西藏', 2, 'xicang', 0),
(29, 1, '新疆', 2, 'xinjiang', 0),
(30, 1, '云南', 2, 'yunnan', 0),
(31, 1, '浙江', 2, 'zhejiang', 0),
(36, 3, '安庆', 3, 'anqing', 0),
(37, 3, '蚌埠', 3, 'bangbu', 0),
(38, 3, '巢湖', 3, 'chaohu', 0),
(39, 3, '池州', 3, 'chizhou', 0),
...
(42, 3, '淮北', 3, 'huaibei', 0),
(43, 3, '淮南', 3, 'huainan', 0),
(44, 3, '黄山', 3, 'huangshan', 0),
(45, 3, '六安', 3, 'liuan', 0),
(46, 3, '马鞍山', 3, 'maanshan', 0),
(47, 3, '宿州', 3, 'suzhou', 0),
(48, 3, '铜陵', 3, 'tongling', 0),
(49, 3, '芜湖', 3, 'wuhu', 0),
(50, 3, '宣城', 3, 'xuancheng', 0),
(51, 3, '亳州', 3, 'zhou', 0),
(52, 2, '北京', 2, 'beijing', 1),
(53, 4, '福州', 3, 'fuzhou', 0),
(54, 4, '龙岩', 3, 'longyan', 0),
...
(56, 4, '宁德', 3, 'ningde', 0),
(57, 4, '莆田', 3, 'putian', 0),
(58, 4, '泉州', 3, 'quanzhou', 0),
(59, 4, '三明', 3, 'sanming', 0),
(60, 4, '厦门', 3, 'xiamen', 0),
(61, 4, '漳州', 3, 'zhangzhou', 0),
(62, 5, '兰州', 3, 'lanzhou', 0),
(63, 5, '白银', 3, 'baiyin', 0),
(64, 5, '定西', 3, 'dingxi', 0),
(65, 5, '甘南', 3, 'gannan', 0),
(66, 5, '嘉峪关', 3, 'jiayuguan', 0),
(67, 5, '金昌', 3, 'jinchang', 0),
(68, 5, '酒泉', 3, 'jiuquan', 0),
(69, 5, '临夏', 3, 'linxia', 0),
(70, 5, '陇南', 3, 'longnan', 0),
(71, 5, '平凉', 3, 'pingliang', 0),
(72, 5, '庆阳', 3, 'qingyang', 0),
(73, 5, '天水', 3, 'tianshui', 0),
(74, 5, '武威', 3, 'wuwei', 0),
(75, 5, '张掖', 3, 'zhangye', 0),
(76, 6, '广州', 3, 'guangzhou', 0),
(77, 6, '深圳', 3, 'shen', 0),
(78, 6, '潮州', 3, 'chaozhou', 0),
(79, 6, '东莞', 3, 'dong', 0),
(80, 6, '佛山', 3, 'foshan', 0),
(81, 6, '河源', 3, 'heyuan', 0),
(82, 6, '惠州', 3, 'huizhou', 0),
(83, 6, '江门', 3, 'jiangmen', 0),
(84, 6, '揭阳', 3, 'jieyang', 0),
(85, 6, '茂名', 3, 'maoming', 0),
(86, 6, '梅州', 3, 'meizhou', 0),
(87, 6, '清远', 3, 'qingyuan', 0),
(88, 6, '汕头', 3, 'shantou', 0),
(89, 6, '汕尾', 3, 'shanwei', 0),
(90, 6, '韶关', 3, 'shaoguan', 0),
(91, 6, '阳江', 3, 'yangjiang', 0),
(92, 6, '云浮', 3, 'yunfu', 0),
(93, 6, '湛江', 3, 'zhanjiang', 0),
(94, 6, '肇庆', 3, 'zhaoqing', 0),
(95, 6, '中山', 3, 'zhongshan', 0),
(96, 6, '珠海', 3, 'zhuhai', 0),
(97, 7, '南宁', 3, 'nanning', 0),
(98, 7, '桂林', 3, 'guilin', 0),
(99, 7, '百色', 3, 'baise', 0),
(100, 7, '北海', 3, 'beihai', 0),
(101, 7, '崇左', 3, 'chongzuo', 0),
(102, 7, '防城港', 3, 'fangchenggang', 0),
(103, 7, '贵港', 3, 'guigang', 0),
(104, 7, '河池', 3, 'hechi', 0),
(105, 7, '贺州', 3, 'hezhou', 0),
(106, 7, '来宾', 3, 'laibin', 0),
(107, 7, '柳州', 3, 'liuzhou', 0),
(108, 7, '钦州', 3, 'qinzhou', 0),
(109, 7, '梧州', 3, 'wuzhou', 0),
(110, 7, '玉林', 3, 'yulin', 0),
(111, 8, '贵阳', 3, 'guiyang', 0),
(112, 8, '安顺', 3, 'anshun', 0),
(113, 8, '毕节', 3, 'bijie', 0),
(114, 8, '六盘水', 3, 'liupanshui', 0),
(115, 8, '黔东南', 3, 'qiandongnan', 0),
(116, 8, '黔南', 3, 'qiannan', 0),
(117, 8, '黔西南', 3, 'qianxinan', 0),
(118, 8, '铜仁', 3, 'tongren', 0),
(119, 8, '遵义', 3, 'zunyi', 0),
(120, 9, '海口', 3, 'haikou', 0),
(121, 9, '三亚', 3, 'sanya', 0),
(122, 9, '白沙', 3, 'baisha', 0),
(123, 9, '保亭', 3, 'baoting', 0),
(124, 9, '昌江', 3, 'changjiang', 0),
(125, 9, '澄迈县', 3, 'chengmaixian', 0),
(126, 9, '定安县', 3, 'dinganxian', 0),
(127, 9, '东方', 3, 'dongfang', 0),
(128, 9, '乐东', 3, 'ledong', 0),
(129, 9, '临高县', 3, 'lingaoxian', 0),
(130, 9, '陵水', 3, 'lingshui', 0),
(131, 9, '琼海', 3, 'qionghai', 0),
(132, 9, '琼中', 3, 'qiongzhong', 0),
(133, 9, '屯昌县', 3, 'tunchangxian', 0),
(134, 9, '万宁', 3, 'wanning', 0),
(135, 9, '文昌', 3, 'wenchang', 0),
(136, 9, '五指山', 3, 'wuzhishan', 0),
(137, 9, '儋州', 3, 'zhou', 0),
(138, 10, '石家庄', 3, 'shijiazhuang', 0),
(139, 10, '保定', 3, 'baoding', 0),
(140, 10, '沧州', 3, 'cangzhou', 0),
(141, 10, '承德', 3, 'chengde', 0),
(142, 10, '邯郸', 3, 'handan', 0),
(143, 10, '衡水', 3, 'hengshui', 0),
(144, 10, '廊坊', 3, 'langfang', 0),
(145, 10, '秦皇岛', 3, 'qinhuangdao', 0),
(146, 10, '唐山', 3, 'tangshan', 0),
(147, 10, '邢台', 3, 'xingtai', 0),
(148, 10, '张家口', 3, 'zhangjiakou', 0),
(149, 11, '郑州', 3, 'zhengzhou', 0),
(150, 11, '洛阳', 3, 'luoyang', 0),
(151, 11, '开封', 3, 'kaifeng', 0),
(152, 11, '安阳', 3, 'anyang', 0),
(153, 11, '鹤壁', 3, 'hebi', 0),
(154, 11, '济源', 3, 'jiyuan', 0),
(155, 11, '焦作', 3, 'jiaozuo', 0),
(156, 11, '南阳', 3, 'nanyang', 0),
(157, 11, '平顶山', 3, 'pingdingshan', 0),
(158, 11, '三门峡', 3, 'sanmenxia', 0),
(159, 11, '商丘', 3, 'shangqiu', 0),
(160, 11, '新乡', 3, 'xinxiang', 0),
(161, 11, '信阳', 3, 'xinyang', 0),
(162, 11, '许昌', 3, 'xuchang', 0),
(163, 11, '周口', 3, 'zhoukou', 0),
(164, 11, '驻马店', 3, 'zhumadian', 0),
(165, 11, '漯河', 3, 'he', 0),
(166, 11, '濮阳', 3, 'yang', 0),
(167, 12, '哈尔滨', 3, 'haerbin', 0),
(168, 12, '大庆', 3, 'daqing', 0),
(169, 12, '大兴安岭', 3, 'daxinganling', 0),
(170, 12, '鹤岗', 3, 'hegang', 0),
(171, 12, '黑河', 3, 'heihe', 0),
(172, 12, '鸡西', 3, 'jixi', 0),
(173, 12, '佳木斯', 3, 'jiamusi', 0),
(174, 12, '牡丹江', 3, 'mudanjiang', 0),
(175, 12, '七台河', 3, 'qitaihe', 0),
(176, 12, '齐齐哈尔', 3, 'qiqihaer', 0),
(177, 12, '双鸭山', 3, 'shuangyashan', 0),
(178, 12, '绥化', 3, 'suihua', 0),
(179, 12, '伊春', 3, 'yichun', 0),
(180, 13, '武汉', 3, 'wuhan', 0),
(181, 13, '仙桃', 3, 'xiantao', 0),
(182, 13, '鄂州', 3, 'ezhou', 0),
(183, 13, '黄冈', 3, 'huanggang', 0),
(184, 13, '黄石', 3, 'huangshi', 0),
(185, 13, '荆门', 3, 'jingmen', 0),
(186, 13, '荆州', 3, 'jingzhou', 0),
(187, 13, '潜江', 3, 'qianjiang', 0),
(188, 13, '神农架林区', 3, 'shennongjialinqu', 0),
(189, 13, '十堰', 3, 'shiyan', 0),
(190, 13, '随州', 3, 'suizhou', 0),
(191, 13, '天门', 3, 'tianmen', 0),
(192, 13, '咸宁', 3, 'xianning', 0),
(193, 13, '襄樊', 3, 'xiangfan', 0),
(194, 13, '孝感', 3, 'xiaogan', 0),
(195, 13, '宜昌', 3, 'yichang', 0),
(196, 13, '恩施', 3, 'enshi', 0),
(197, 14, '长沙', 3, 'changsha', 0),
(198, 14, '张家界', 3, 'zhangjiajie', 0),
(199, 14, '常德', 3, 'changde', 0),
(200, 14, '郴州', 3, 'chenzhou', 0),
(201, 14, '衡阳', 3, 'hengyang', 0),
(202, 14, '怀化', 3, 'huaihua', 0),
(203, 14, '娄底', 3, 'loudi', 0),
(204, 14, '邵阳', 3, 'shaoyang', 0),
(205, 14, '湘潭', 3, 'xiangtan', 0),
(206, 14, '湘西', 3, 'xiangxi', 0),
(207, 14, '益阳', 3, 'yiyang', 0),
(208, 14, '永州', 3, 'yongzhou', 0),
(209, 14, '岳阳', 3, 'yueyang', 0),
(210, 14, '株洲', 3, 'zhuzhou', 0),
(211, 15, '长春', 3, 'changchun', 0),
(212, 15, '吉林', 3, 'jilin', 0),
(213, 15, '白城', 3, 'baicheng', 0),
(214, 15, '白山', 3, 'baishan', 0),
(215, 15, '辽源', 3, 'liaoyuan', 0),
(216, 15, '四平', 3, 'siping', 0),
(217, 15, '松原', 3, 'songyuan', 0),
(218, 15, '通化', 3, 'tonghua', 0),
(219, 15, '延边', 3, 'yanbian', 0),
(220, 16, '南京', 3, 'nanjing', 0),
(221, 16, '苏州', 3, 'suzhou', 0),
(222, 16, '无锡', 3, 'wuxi', 0),
(223, 16, '常州', 3, 'changzhou', 0),
(224, 16, '淮安', 3, 'huaian', 0),
(225, 16, '连云港', 3, 'lianyungang', 0),
(226, 16, '南通', 3, 'nantong', 0),
(227, 16, '宿迁', 3, 'suqian', 0),
(228, 16, '泰州', 3, 'taizhou', 0),
(229, 16, '徐州', 3, 'xuzhou', 0),
(230, 16, '盐城', 3, 'yancheng', 0),
(231, 16, '扬州', 3, 'yangzhou', 0),
(232, 16, '镇江', 3, 'zhenjiang', 0),
(233, 17, '南昌', 3, 'nanchang', 0),
(234, 17, '抚州', 3, 'fuzhou', 0),
(235, 17, '赣州', 3, 'ganzhou', 0),
(236, 17, '吉安', 3, 'jian', 0),
(237, 17, '景德镇', 3, 'jingdezhen', 0),
(238, 17, '九江', 3, 'jiujiang', 0),
(239, 17, '萍乡', 3, 'pingxiang', 0),
(240, 17, '上饶', 3, 'shangrao', 0),
(241, 17, '新余', 3, 'xinyu', 0),
(242, 17, '宜春', 3, 'yichun', 0),
(243, 17, '鹰潭', 3, 'yingtan', 0),
(244, 18, '沈阳', 3, 'shenyang', 0),
(245, 18, '大连', 3, 'dalian', 0),
(246, 18, '鞍山', 3, 'anshan', 0),
(247, 18, '本溪', 3, 'benxi', 0),
(248, 18, '朝阳', 3, 'chaoyang', 0),
(249, 18, '丹东', 3, 'dandong', 0),
(250, 18, '抚顺', 3, 'fushun', 0),
(251, 18, '阜新', 3, 'fuxin', 0),
(252, 18, '葫芦岛', 3, 'huludao', 0),
(253, 18, '锦州', 3, 'jinzhou', 0),
(254, 18, '辽阳', 3, 'liaoyang', 0),
(255, 18, '盘锦', 3, 'panjin', 0),
(256, 18, '铁岭', 3, 'tieling', 0),
(257, 18, '营口', 3, 'yingkou', 0),
(258, 19, '呼和浩特', 3, 'huhehaote', 0),
(259, 19, '阿拉善盟', 3, 'alashanmeng', 0),
(260, 19, '巴彦淖尔盟', 3, 'bayannaoermeng', 0),
(261, 19, '包头', 3, 'baotou', 0),
(262, 19, '赤峰', 3, 'chifeng', 0),
(263, 19, '鄂尔多斯', 3, 'eerduosi', 0),
(264, 19, '呼伦贝尔', 3, 'hulunbeier', 0),
(265, 19, '通辽', 3, 'tongliao', 0),
(266, 19, '乌海', 3, 'wuhai', 0),
(267, 19, '乌兰察布市', 3, 'wulanchabushi', 0),
(268, 19, '锡林郭勒盟', 3, 'xilinguolemeng', 0),
(269, 19, '兴安盟', 3, 'xinganmeng', 0),
(270, 20, '银川', 3, 'yinchuan', 0),
(271, 20, '固原', 3, 'guyuan', 0),
(272, 20, '石嘴山', 3, 'shizuishan', 0),
(273, 20, '吴忠', 3, 'wuzhong', 0),
(274, 20, '中卫', 3, 'zhongwei', 0),
(275, 21, '西宁', 3, 'xining', 0),
(276, 21, '果洛', 3, 'guoluo', 0),
(277, 21, '海北', 3, 'haibei', 0),
(278, 21, '海东', 3, 'haidong', 0),
(279, 21, '海南', 3, 'hainan', 0),
(280, 21, '海西', 3, 'haixi', 0),
(281, 21, '黄南', 3, 'huangnan', 0),
(282, 21, '玉树', 3, 'yushu', 0),
(283, 22, '济南', 3, 'jinan', 0),
(284, 22, '青岛', 3, 'qingdao', 0),
(285, 22, '滨州', 3, 'binzhou', 0),
(286, 22, '德州', 3, 'dezhou', 0),
(287, 22, '东营', 3, 'dongying', 0),
(288, 22, '菏泽', 3, 'heze', 0),
(289, 22, '济宁', 3, 'jining', 0),
(290, 22, '莱芜', 3, 'laiwu', 0),
(291, 22, '聊城', 3, 'liaocheng', 0),
(292, 22, '临沂', 3, 'linyi', 0),
(293, 22, '日照', 3, 'rizhao', 0),
(294, 22, '泰安', 3, 'taian', 0),
(295, 22, '威海', 3, 'weihai', 0),
(296, 22, '潍坊', 3, 'weifang', 0),
(297, 22, '烟台', 3, 'yantai', 0),
(298, 22, '枣庄', 3, 'zaozhuang', 0),
(299, 22, '淄博', 3, 'zibo', 0),
(300, 23, '太原', 3, 'taiyuan', 0),
(301, 23, '长治', 3, 'changzhi', 0),
(302, 23, '大同', 3, 'datong', 0),
(303, 23, '晋城', 3, 'jincheng', 0),
(304, 23, '晋中', 3, 'jinzhong', 0),
(305, 23, '临汾', 3, 'linfen', 0),
(306, 23, '吕梁', 3, 'lvliang', 0),
(307, 23, '朔州', 3, 'shuozhou', 0),
(308, 23, '忻州', 3, 'xinzhou', 0),
(309, 23, '阳泉', 3, 'yangquan', 0),
(310, 23, '运城', 3, 'yuncheng', 0),
(311, 24, '西安', 3, 'xian', 0),
(312, 24, '安康', 3, 'ankang', 0),
(313, 24, '宝鸡', 3, 'baoji', 0),
(314, 24, '汉中', 3, 'hanzhong', 0),
(315, 24, '商洛', 3, 'shangluo', 0),
(316, 24, '铜川', 3, 'tongchuan', 0),
(317, 24, '渭南', 3, 'weinan', 0),
(318, 24, '咸阳', 3, 'xianyang', 0),
(319, 24, '延安', 3, 'yanan', 0),
(320, 24, '榆林', 3, 'yulin', 0),
(321, 25, '上海', 2, 'shanghai', 0),
(322, 26, '成都', 3, 'chengdu', 0),
(323, 26, '绵阳', 3, 'mianyang', 0),
(324, 26, '阿坝', 3, 'aba', 0),
(325, 26, '巴中', 3, 'bazhong', 0),
(326, 26, '达州', 3, 'dazhou', 0),
(327, 26, '德阳', 3, 'deyang', 0),
(328, 26, '甘孜', 3, 'ganzi', 0),
(329, 26, '广安', 3, 'guangan', 0),
(330, 26, '广元', 3, 'guangyuan', 0),
(331, 26, '乐山', 3, 'leshan', 0),
(332, 26, '凉山', 3, 'liangshan', 0),
(333, 26, '眉山', 3, 'meishan', 0),
(334, 26, '南充', 3, 'nanchong', 0),
(335, 26, '内江', 3, 'neijiang', 0),
(336, 26, '攀枝花', 3, 'panzhihua', 0),
(337, 26, '遂宁', 3, 'suining', 0),
(338, 26, '雅安', 3, 'yaan', 0),
(339, 26, '宜宾', 3, 'yibin', 0),
(340, 26, '资阳', 3, 'ziyang', 0),
(341, 26, '自贡', 3, 'zigong', 0),
(342, 26, '泸州', 3, 'zhou', 0),
(343, 27, '天津', 2, 'tianjin', 0),
(344, 28, '拉萨', 3, 'lasa', 0),
(345, 28, '阿里', 3, 'ali', 0),
(346, 28, '昌都', 3, 'changdu', 0),
(347, 28, '林芝', 3, 'linzhi', 0),
(348, 28, '那曲', 3, 'naqu', 0),
(349, 28, '日喀则', 3, 'rikaze', 0),
(350, 28, '山南', 3, 'shannan', 0),
(351, 29, '乌鲁木齐', 3, 'wulumuqi', 0),
(352, 29, '阿克苏', 3, 'akesu', 0),
(353, 29, '阿拉尔', 3, 'alaer', 0),
(354, 29, '巴音郭楞', 3, 'bayinguoleng', 0),
(355, 29, '博尔塔拉', 3, 'boertala', 0),
(356, 29, '昌吉', 3, 'changji', 0),
(357, 29, '哈密', 3, 'hami', 0),
(358, 29, '和田', 3, 'hetian', 0),
(359, 29, '喀什', 3, 'kashi', 0),
(360, 29, '克拉玛依', 3, 'kelamayi', 0),
(361, 29, '克孜勒苏', 3, 'kezilesu', 0),
(362, 29, '石河子', 3, 'shihezi', 0),
(363, 29, '图木舒克', 3, 'tumushuke', 0),
(364, 29, '吐鲁番', 3, 'tulufan', 0),
(365, 29, '五家渠', 3, 'wujiaqu', 0),
(366, 29, '伊犁', 3, 'yili', 0),
(367, 30, '昆明', 3, 'kunming', 0),
(368, 30, '怒江', 3, 'nujiang', 0),
(369, 30, '普洱', 3, 'puer', 0),
(370, 30, '丽江', 3, 'lijiang', 0),
(371, 30, '保山', 3, 'baoshan', 0),
(372, 30, '楚雄', 3, 'chuxiong', 0),
(373, 30, '大理', 3, 'dali', 0),
(374, 30, '德宏', 3, 'dehong', 0),
(375, 30, '迪庆', 3, 'diqing', 0),
(376, 30, '红河', 3, 'honghe', 0),
(377, 30, '临沧', 3, 'lincang', 0),
(378, 30, '曲靖', 3, 'qujing', 0),
(379, 30, '文山', 3, 'wenshan', 0),
(380, 30, '西双版纳', 3, 'xishuangbanna', 0),
(381, 30, '玉溪', 3, 'yuxi', 0),
(382, 30, '昭通', 3, 'zhaotong', 0),
(383, 31, '杭州', 3, 'hangzhou', 0),
(384, 31, '湖州', 3, 'huzhou', 0),
(385, 31, '嘉兴', 3, 'jiaxing', 0),
(386, 31, '金华', 3, 'jinhua', 0),
(387, 31, '丽水', 3, 'lishui', 0),
(388, 31, '宁波', 3, 'ningbo', 0),
(389, 31, '绍兴', 3, 'shaoxing', 0),
(390, 31, '台州', 3, 'taizhou', 0),
(391, 31, '温州', 3, 'wenzhou', 0),
(392, 31, '舟山', 3, 'zhoushan', 0),
(393, 31, '衢州', 3, 'zhou', 0),
(394, 32, '重庆', 2, 'zhongqing', 0),
(395, 33, '香港', 2, 'xianggang', 0),
(396, 34, '澳门', 2, 'aomen', 0),
(397, 35, '台湾', 2, 'taiwan', 0),
(500, 52, '东城区', 3, 'dongchengqu', 0),
(501, 52, '西城区', 3, 'xichengqu', 0),
(502, 52, '海淀区', 3, 'haidianqu', 0),
(503, 52, '朝阳区', 3, 'chaoyangqu', 0),
(504, 52, '崇文区', 3, 'chongwenqu', 0),
(505, 52, '宣武区', 3, 'xuanwuqu', 0),
(506, 52, '丰台区', 3, 'fengtaiqu', 0),
(507, 52, '石景山区', 3, 'shijingshanqu', 0),
(508, 52, '房山区', 3, 'fangshanqu', 0),
(509, 52, '门头沟区', 3, 'mentougouqu', 0),
(510, 52, '通州区', 3, 'tongzhouqu', 0),
(511, 52, '顺义区', 3, 'shunyiqu', 0),
(512, 52, '昌平区', 3, 'changpingqu', 0),
(513, 52, '怀柔区', 3, 'huairouqu', 0),
(514, 52, '平谷区', 3, 'pingguqu', 0),
(515, 52, '大兴区', 3, 'daxingqu', 0),
(516, 52, '密云县', 3, 'miyunxian', 0),
(517, 52, '延庆县', 3, 'yanqingxian', 0),
(2703, 321, '长宁区', 3, 'changningqu', 0),
(2704, 321, '闸北区', 3, 'zhabeiqu', 0),
(2705, 321, '闵行区', 3, 'xingqu', 0),
(2706, 321, '徐汇区', 3, 'xuhuiqu', 0),
(2707, 321, '浦东新区', 3, 'pudongxinqu', 0),
(2708, 321, '杨浦区', 3, 'yangpuqu', 0),
(2709, 321, '普陀区', 3, 'putuoqu', 0),
(2710, 321, '静安区', 3, 'jinganqu', 0),
(2711, 321, '卢湾区', 3, 'luwanqu', 0),
(2712, 321, '虹口区', 3, 'hongkouqu', 0),
(2713, 321, '黄浦区', 3, 'huangpuqu', 0),
(2714, 321, '南汇区', 3, 'nanhuiqu', 0),
(2715, 321, '松江区', 3, 'songjiangqu', 0),
(2716, 321, '嘉定区', 3, 'jiadingqu', 0),
(2717, 321, '宝山区', 3, 'baoshanqu', 0),
(2718, 321, '青浦区', 3, 'qingpuqu', 0),
(2719, 321, '金山区', 3, 'jinshanqu', 0),
(2720, 321, '奉贤区', 3, 'fengxianqu', 0),
(2721, 321, '崇明县', 3, 'chongmingxian', 0),
(2912, 343, '和平区', 3, 'hepingqu', 0),
(2913, 343, '河西区', 3, 'hexiqu', 0),
(2914, 343, '南开区', 3, 'nankaiqu', 0),
(2915, 343, '河北区', 3, 'hebeiqu', 0),
(2916, 343, '河东区', 3, 'hedongqu', 0),
(2917, 343, '红桥区', 3, 'hongqiaoqu', 0),
(2918, 343, '东丽区', 3, 'dongliqu', 0),
(2919, 343, '津南区', 3, 'jinnanqu', 0),
(2920, 343, '西青区', 3, 'xiqingqu', 0),
(2921, 343, '北辰区', 3, 'beichenqu', 0),
(2922, 343, '塘沽区', 3, 'tangguqu', 0),
(2923, 343, '汉沽区', 3, 'hanguqu', 0),
(2924, 343, '大港区', 3, 'dagangqu', 0),
(2925, 343, '武清区', 3, 'wuqingqu', 0),
(2926, 343, '宝坻区', 3, 'baoqu', 0),
(2927, 343, '经济开发区', 3, 'jingjikaifaqu', 0),
(2928, 343, '宁河县', 3, 'ninghexian', 0),
(2929, 343, '静海县', 3, 'jinghaixian', 0),
(2930, 343, '蓟县', 3, 'jixian', 0),
(3325, 394, '合川区', 3, 'hechuanqu', 0),
(3326, 394, '江津区', 3, 'jiangjinqu', 0),
(3327, 394, '南川区', 3, 'nanchuanqu', 0),
(3328, 394, '永川区', 3, 'yongchuanqu', 0),
(3329, 394, '南岸区', 3, 'nananqu', 0),
(3330, 394, '渝北区', 3, 'yubeiqu', 0),
(3331, 394, '万盛区', 3, 'wanshengqu', 0),
(3332, 394, '大渡口区', 3, 'dadukouqu', 0),
(3333, 394, '万州区', 3, 'wanzhouqu', 0),
(3334, 394, '北碚区', 3, 'beiqu', 0),
(3335, 394, '沙坪坝区', 3, 'shapingbaqu', 0),
(3336, 394, '巴南区', 3, 'bananqu', 0),
(3337, 394, '涪陵区', 3, 'fulingqu', 0),
(3338, 394, '江北区', 3, 'jiangbeiqu', 0),
(3339, 394, '九龙坡区', 3, 'jiulongpoqu', 0),
(3340, 394, '渝中区', 3, 'yuzhongqu', 0),
(3341, 394, '黔江开发区', 3, 'qianjiangkaifaqu', 0),
(3342, 394, '长寿区', 3, 'changshouqu', 0),
(3343, 394, '双桥区', 3, 'shuangqiaoqu', 0),
(3344, 394, '綦江县', 3, 'jiangxian', 0),
(3345, 394, '潼南县', 3, 'nanxian', 0),
(3346, 394, '铜梁县', 3, 'tongliangxian', 0),
(3347, 394, '大足县', 3, 'dazuxian', 0),
(3348, 394, '荣昌县', 3, 'rongchangxian', 0),
(3349, 394, '璧山县', 3, 'shanxian', 0),
(3350, 394, '垫江县', 3, 'dianjiangxian', 0),
(3351, 394, '武隆县', 3, 'wulongxian', 0),
(3352, 394, '丰都县', 3, 'fengduxian', 0),
(3353, 394, '城口县', 3, 'chengkouxian', 0),
(3354, 394, '梁平县', 3, 'liangpingxian', 0),
(3355, 394, '开县', 3, 'kaixian', 0),
(3356, 394, '巫溪县', 3, 'wuxixian', 0),
(3357, 394, '巫山县', 3, 'wushanxian', 0),
(3358, 394, '奉节县', 3, 'fengjiexian', 0),
(3359, 394, '云阳县', 3, 'yunyangxian', 0),
(3360, 394, '忠县', 3, 'zhongxian', 0),
(3361, 394, '石柱', 3, 'shizhu', 0),
(3362, 394, '彭水', 3, 'pengshui', 0),
(3363, 394, '酉阳', 3, 'youyang', 0),
(3364, 394, '秀山', 3, 'xiushan', 0),
(3365, 395, '沙田区', 3, 'shatianqu', 0),
(3366, 395, '东区', 3, 'dongqu', 0),
(3367, 395, '观塘区', 3, 'guantangqu', 0),
(3368, 395, '黄大仙区', 3, 'huangdaxianqu', 0),
(3369, 395, '九龙城区', 3, 'jiulongchengqu', 0),
(3370, 395, '屯门区', 3, 'tunmenqu', 0),
(3371, 395, '葵青区', 3, 'kuiqingqu', 0),
(3372, 395, '元朗区', 3, 'yuanlangqu', 0),
(3373, 395, '深水埗区', 3, 'shenshui', 0),
(3374, 395, '西贡区', 3, 'xigongqu', 0),
(3375, 395, '大埔区', 3, 'dapuqu', 0),
(3376, 395, '湾仔区', 3, 'wanziqu', 0),
(3377, 395, '油尖旺区', 3, 'youjianwangqu', 0),
(3378, 395, '北区', 3, 'beiqu', 0),
(3379, 395, '南区', 3, 'nanqu', 0),
(3380, 395, '荃湾区', 3, 'wanqu', 0),
(3381, 395, '中西区', 3, 'zhongxiqu', 0),
(3382, 395, '离岛区', 3, 'lidaoqu', 0),
(3383, 396, '澳门', 3, 'aomen', 0),
(3384, 397, '台北', 3, 'taibei', 0),
(3385, 397, '高雄', 3, 'gaoxiong', 0),
(3386, 397, '基隆', 3, 'jilong', 0),
(3387, 397, '台中', 3, 'taizhong', 0),
(3388, 397, '台南', 3, 'tainan', 0),
(3389, 397, '新竹', 3, 'xinzhu', 0),
(3390, 397, '嘉义', 3, 'jiayi', 0),
(3391, 397, '宜兰县', 3, 'yilanxian', 0),
(3392, 397, '桃园县', 3, 'taoyuanxian', 0),
(3393, 397, '苗栗县', 3, 'miaolixian', 0),
(3394, 397, '彰化县', 3, 'zhanghuaxian', 0),
(3395, 397, '南投县', 3, 'nantouxian', 0),
(3396, 397, '云林县', 3, 'yunlinxian', 0),
(3397, 397, '屏东县', 3, 'pingdongxian', 0),
(3398, 397, '台东县', 3, 'taidongxian', 0),
(3399, 397, '花莲县', 3, 'hualianxian', 0),
(3400, 397, '澎湖县', 3, 'penghuxian', 0),
(1, 0, '全国', 1, 'quanguo', 0);
...
CREATE TABLE IF NOT EXISTS `%DB_PREFIX%role` (
  ...
  `is_delete` tinyint(1) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='//后台的权限节点' AUTO_INCREMENT=5 ;
...
CREATE TABLE IF NOT EXISTS `%DB_PREFIX%role_access` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='//访问权限' AUTO_INCREMENT=106 ;

--
-- 转存表中的数据 `%DB_PREFIX%role_access`
--

INSERT INTO `%DB_PREFIX%role_access` (`id`, `role_id`, `node_id`, `module_id`, `action_id`) VALUES
(100, 4, 7064, 131, 0),
(99, 4, 681, 131, 0),
(98, 4, 198, 15, 0),
(97, 4, 19, 15, 0),
...
CREATE TABLE IF NOT EXISTS `%DB_PREFIX%role_group` (
  ...
  `sort` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='//组权限' AUTO_INCREMENT=90 ;
...
CREATE TABLE IF NOT EXISTS `%DB_PREFIX%role_module` (
  ...
  `is_delete` tinyint(1) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='//模块权限' AUTO_INCREMENT=246 ;
...
(127, 'PromoteMsg', '推广模块', 1, 0),
(128, 'PromoteMsgList', '推广队列', 1, 0),
(130, 'LinkGroup', '友情链接分组', 1, 0),
(129, 'Link', '友情链接', 1, 0),
(131, 'UserLevel', '会员等级', 1, 0),
(132, 'DealLevel', '项目等级', 0, 0),
(133, 'Article', '文章', 1, 0),
(134, 'ArticleCate', '文章分类', 1, 0),
(135, 'RegionConf', '地区', 1, 0),
(136, 'SqlCheck', '系统监测', 1, 0),
(93, 'MAdv', '手机端广告', 1, 0),
(137, 'UserInvestor', '投资人申请管理', 1, 0),
(139, 'Vote', '问卷调查', 1, 0),
(138, 'Bank', '提现银行设置', 1, 0),
(141, 'Collocation', '资金托管', 1, 0),
(140, 'UserCarry', '提现手续费', 1, 0),
(142, 'Referrals', '会员邀请', 1, 0),
(143, 'Statistics', '统计', 1, 0),
(144, 'Message', '留言列表', 1, 0),
(145, 'MessageCate', '留言分类列表', 1, 0),
(151, 'UserFreeze', '冻结资金列表', 1, 0),
(153, 'MoneyFreezes', '诚意金管理', 1, 0),
(152, 'UserUnfreeze', '申请解冻资金列表', 1, 0),
(155, 'YeepayWithdraw', '第三方托管提现', 1, 0),
(154, 'YeepayRecharge', '第三方托管充值', 1, 0),
(156, 'MoneyFreeze', '第三方托管诚意金', 1, 0),
(160, 'DealHouseCate', '房产众筹分类', 1, 0),
(161, 'StockTransfer', '债权转让管理', 1, 0),
(162, 'Finance', '融资公司管理', 1, 0),
(164, 'StationMessage', '站内消息管理', 1, 0),
(165, 'Contract', '合同范本设置', 1, 0),
(166, 'WeixinConf', '微信第三方平台', 1, 0),
(167, 'WeixinInfo', '微信配置', 1, 0),
(168, 'WeixinReply', '微信回复设置', 1, 0),
(169, 'WeixinTemplate', '微信模板设置', 1, 0),
(170, 'WeixinUser', '微信会员管理', 1, 0),
(171, 'Licai', '理财管理', 1, 0),
(172, 'LicaiHistory', '收益率管理', 1, 0),
(173, 'LicaiRecommend', '个性推荐设置', 1, 0),
(174, 'LicaiOrder', '购买记录', 1, 0),
(175, 'LicaiDealshow', '首页订单展示设置', 1, 0),
(176, 'LicaiBank', '银行列表', 1, 0),
(177, 'LicaiFundType', '基金种类', 1, 0),
(178, 'LicaiFundBrand', '基金品牌', 1, 0),
(179, 'LicaiRedempte', '赎回管理', 1, 0),
(180, 'LicaiNear', '理财发放管理', 1, 0),
(181, 'LicaiSend', '理财已发放管理', 1, 0),
(182, 'LicaiAdvance', '垫付单管理', 1, 0),
(183, 'Goods', '积分商城商品管理', 1, 0),
(184, 'GoodsCate', '积分商城分类管理', 1, 0),
(185, 'GoodsOrder', '积分商城兑换管理', 1, 0),
(186, 'LicaiHoliday', '理财假日管理', 1, 0),
(122, 'Faq', '常见问题', 1, 0),
(121, 'Help', '站点帮助', 1, 0),
...
(6, 'Admin', '管理员', 1, 0),
(5, 'Role', '权限组别', 1, 0),
(245, 'UserConfirmRefund', '提现确认记录', 1, 0),
(188, 'LicaiInterest', '收益率设置', 1, 0),
(189, 'ReferralsTotal', '统计', 1, 0),
(190, 'DealOnline', '上线产品项目', 1, 0),
(191, 'DealSubmit', '未审核产品项目', 1, 0),
(192, 'DealDelete', '产品项目回收站', 1, 0),
(193, 'DealSelflessCate', '公益众筹分类', 1, 0),
(194, 'DealSelflessOnline', '上线公益项目', 1, 0),
(195, 'DealSelflessSubmit', '未审核公益项目', 1, 0),
(196, 'DealSelflessDelete', '公益项目回收站', 1, 0),
(197, 'DealInvestorCate', '股权众筹分类', 1, 0),
(198, 'DealInvestorOnline', '上线股权项目', 1, 0),
(199, 'DealInvestorSubmit', '未审核股权项目', 1, 0),
(200, 'DealInvestorDelete', '股权项目回收站', 1, 0),
(201, 'DealFinanceCate', '融资众筹分类', 1, 0),
(202, 'DealFinanceOnline', '上线融资项目', 1, 0),
(203, 'DealFinanceSubmit', '未审核融资项目', 1, 0),
(204, 'DealFinanceDelete', '融资项目回收站', 1, 0),
(205, 'DealHouseOnline', '上线房产项目', 1, 0),
(206, 'DealHouseSubmit', '未审核房产项目', 1, 0),
(207, 'DealHouseDelete', '房产项目回收站', 1, 0),
(208, 'DealSubmitUserBonus', '未审核分红列表', 1, 0),
(209, 'DealSubmitFixedInterest', '未审核固定回报列表', 1, 0),
(210, 'DealSubmitBuyHouseEarnings', '未审核买房收益列表', 1, 0),
(211, 'StockTransferList', '已审核转让列表', 1, 0),
(212, 'FinanceSubmit', '未审核公司', 1, 0),
(213, 'ArticleCateTrash', '文章分类回收站', 1, 0),
(214, 'ArticleTrash', '文章回收站', 1, 0),
(215, 'PromoteMsgMail', '邮件列表', 1, 0),
(216, 'PromoteMsgSms', '短信列表', 1, 0),
(217, 'StationMessageMsgList', '站内消息队列列表', 1, 0),
(218, 'StatisticsProject', '项目统计', 1, 0),
(219, 'StatisticsUsernumTotal', '人数统计', 1, 0),
(220, 'StatisticsMoneyTotal', '金额统计', 1, 0),
(221, 'StatisticsHasbackTotal', '回报统计', 1, 0),
(222, 'StatisticsOverdueTotal', '逾期统计', 1, 0),
(223, 'StatisticsInvesteTotal', '项目统计', 1, 0),
(224, 'StatisticsInvestorsTotal', '投资人统计', 1, 0),
(225, 'StatisticsFinancingAmountTotal', '融资金额统计', 1, 0),
(226, 'StatisticsBreachConventionTotal', '违约统计', 1, 0),
(227, 'StatisticsMoneyInchangeTotal', '充值统计', 1, 0),
(228, 'StatisticsMoneyCarryBankTotal', '提现统计', 1, 0),
(229, 'StatisticsUserTotal', '用户统计', 1, 0),
(230, 'StatisticsSiteCostsTotal', '网站费用统计', 1, 0),
(231, 'RoleTrash', '管理员分组回收站', 1, 0),
(232, 'AdminTrash', '管理员回收站', 1, 0),
(233, 'DatabaseSql', 'SQL操作', 1, 0),
(234, 'WeixinInfoNavSetting', '自定义菜单', 1, 0),
(235, 'WeixinReplyOnfocus', '关注时回复', 1, 0),
(236, 'WeixinReplyTxt', '文本回复', 1, 0),
(237, 'WeixinReplyNews', '图文回复', 1, 0),
(238, 'WeixinReplyLbs', 'LBS回复', 1, 0),
(239, 'WeixinTemplateSetIndustry', '设置行业', 1, 0),
(240, 'WeixinTemplateMsglist', '模板消息队列', 1, 0),
(241, 'WeixinUserGroups', '分组管理', 1, 0),
(242, 'WeixinUserMessageSend', '普通消息群发', 1, 0),
(243, 'WeixinUserAdvanced', '高级群发', 1, 0),
(244, 'LicaiRedempteBefore', '预热期赎回管理', 1, 0);
...
CREATE TABLE IF NOT EXISTS `%DB_PREFIX%role_nav` (
  ...
  `sort` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='// 导航权限' AUTO_INCREMENT=16 ;
...
CREATE TABLE IF NOT EXISTS `%DB_PREFIX%role_node` (
  ...
  `action_id` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='// 权限节点' AUTO_INCREMENT=7467 ;

--
-- 转存表中的数据 `%DB_PREFIX%role_node`
--

INSERT INTO `%DB_PREFIX%role_node` (`id`, `action`, `name`, `is_effect`, `is_delete`, `group_id`, `module_id`, `action_id`) VALUES
(7276, 'breach_convention_info', '查看', 1, 0, 0, 226, 6881),
(7275, 'export_csv_financing_amount_info', '导出融资金额统计明细', 1, 0, 0, 225, 6880),
(7272, 'investors_info', '查看', 1, 0, 0, 224, 6879),
(7273, 'export_csv_investors_info', '导出投资人统计明细', 1, 0, 0, 224, 6879),
(7274, 'financing_amount_info', '查看', 1, 0, 0, 225, 6880),
(7271, 'export_csv_investe_info', '导出项目统计明细', 1, 0, 0, 223, 6875),
(7270, 'export_csv_overdue_info', '导出逾期明细', 1, 0, 0, 222, 6878),
(7269, 'overdue_info', '查看', 1, 0, 0, 222, 6878),
(7268, 'export_csv_hasback_info', '导出回报明细', 1, 0, 0, 221, 6877),
(7267, 'hasback_info', '查看', 1, 0, 0, 221, 6877),
(7264, 'export_csv_usernum_info', '导出支持明细', 1, 0, 0, 219, 6874),
(7266, 'export_csv_money_info', '导出金额明细', 1, 0, 0, 220, 6876),
(7265, 'money_info', '查看', 1, 0, 0, 220, 6876),
(7263, 'usernum_info', '查看', 1, 0, 0, 219, 6874),
(7262, 'export_csv_project_info', '导出项目明细', 1, 0, 0, 218, 6872),
(7261, 'edit_sms', '编辑', 1, 0, 0, 216, 668),
(7260, 'add_sms', '新增', 1, 0, 0, 216, 668),
(7466, 'show_content', '查看', 1, 0, 0, 217, 0),
(7257, 'do_vote_ask', '编辑执行', 1, 0, 0, 139, 6869),
(7255, 'update_deal_item', '编辑执行', 1, 0, 0, 118, 7153),
(7254, 'edit_deal_item', '编辑子项目', 1, 0, 0, 118, 7153),
(7253, 'del_deal_item', '删除子项目', 1, 0, 0, 118, 7153),
(7252, 'add_deal_item', '添加子项目', 1, 0, 0, 118, 7153),
(7457, 'toogle_status', '设置首页类型', 1, 0, 0, 194, 0),
(7248, 'add_deal_item', '添加子项目', 1, 0, 0, 191, 632),
(7249, 'del_deal_item', '删除子项目', 1, 0, 0, 191, 632),
(7250, 'edit_deal_item', '编辑子项目', 1, 0, 0, 191, 632),
(7449, 'order_index', '购买记录列表', 1, 0, 0, 171, 0),
(7245, 'content', '查看', 1, 0, 0, 144, 6887),
(7244, 'investor_go_allow', '审核执行', 1, 0, 0, 137, 6867),
(7243, 'account', '账户管理', 1, 0, 0, 113, 607),
(7242, 'restore', '恢复', 1, 0, 0, 118, 7240),
(7241, 'foreverdelete', '彻底删除', 1, 0, 0, 118, 7240),
(7240, 'delete_house_index', '项目回收站', 1, 0, 0, 118, 7240),
(7239, 'foreverdelete', '彻底删除', 1, 0, 0, 118, 7153),
(7238, 'deal_item', '子项目', 1, 0, 0, 118, 7153),
(7237, 'edit', '编辑上架', 1, 0, 0, 118, 7153),
(7236, 'do_delivery', '发货', 1, 0, 0, 185, 7052),
(7235, 'cancel_order_do', '取消兑换', 1, 0, 0, 185, 7052),
(7233, 'delete', '删除记录', 1, 0, 0, 245, 7231),
(7234, 'export_csv', '导出', 1, 0, 0, 245, 7231),
(7232, 'refund_confirm', '确认提现', 1, 0, 0, 245, 7231),
(7231, 'confirm_list', '提现确认列表', 1, 0, 78, 245, 7231),
(7230, 'update_deal_item', '更新子项目', 1, 0, 0, 118, 7134),
(7228, 'edit_deal_item', '编辑子项目', 1, 0, 0, 118, 7134),
(7229, 'del_deal_item', '删除子项目', 1, 0, 0, 118, 7134),
(7226, 'deal_item', '子项目列表', 1, 0, 0, 118, 7134),
(7227, 'add_deal_item', '新增子项目', 1, 0, 0, 118, 7134),
(7225, 'del_pay_log', '删除发放', 1, 0, 0, 118, 7134),
(7224, 'save_pay_log', '发放', 1, 0, 0, 118, 7134),
(7223, 'pay_log', '筹款发放', 1, 0, 0, 118, 7134),
(7221, 'del_deal_log', '删除日志', 1, 0, 0, 118, 7134),
(7222, 'sharefee_list', '子项目列表', 1, 0, 0, 118, 7134),
(7220, 'deal_log', '项目日志', 1, 0, 0, 118, 7134),
(7219, 'set_sort', '排序', 1, 0, 0, 118, 7134),
(7217, 'delete', '删除', 1, 0, 0, 118, 7134),
(7215, 'add', '新增房产众筹 ', 1, 0, 0, 118, 7134),
(7216, 'edit', '编辑', 1, 0, 0, 118, 7134),
(7213, 'foreverdelete', '彻底删除 ', 1, 0, 0, 165, 6945),
(7214, 'restore', '恢复 ', 1, 0, 0, 165, 6945),
(7212, 'set_sort', '排序 ', 1, 0, 0, 122, 646),
(7211, 'show_content', '显示内容', 1, 0, 0, 128, 674),
(7202, 'edit_mail', '编辑', 1, 0, 0, 215, 667),
(7203, 'add_mail', '新增 ', 1, 0, 0, 215, 667),
(7201, 'set_effect', '设置状态 ', 1, 0, 0, 139, 6869),
(7198, 'foreverdelete', '彻底删除 ', 1, 0, 0, 36, 43),
(7199, 'vote_ask', '编辑问卷 ', 1, 0, 0, 139, 6869),
(7200, 'set_sort', '排序 ', 1, 0, 0, 139, 6869),
(7196, 'get_pay_list', '投资列表 ', 1, 0, 0, 123, 656),
(7197, 'add', '新增 ', 1, 0, 0, 36, 43),
(7195, 'set_sort', '排序', 1, 0, 0, 160, 6912),
(7193, 'set_sort', '排序', 1, 0, 0, 117, 627),
(7194, 'set_effect', '修改状态', 1, 0, 0, 160, 6912),
(7191, 'export_q_csv', '导出', 1, 0, 0, 244, 7031),
(7192, 'edit', '编辑', 1, 0, 0, 117, 627),
(7190, 'status', '同意赎回', 1, 0, 0, 244, 7031),
(7188, 'save_industry', '保存', 1, 0, 0, 239, 6967),
(7189, 'syn_industry_to_weixin', '同步到微信公众平台', 1, 0, 0, 239, 6967),
(7187, 'save_onfocusn', '保存关注时图文回复', 1, 0, 0, 235, 6959),
(7186, 'save_onfocus', '保存关注时文本回复', 1, 0, 0, 235, 6959),
(7184, 'save_dtext', '保存默认文本回复', 1, 0, 0, 168, 6958),
(7185, 'save_dnews', '保存默认图文回复', 1, 0, 0, 168, 6958),
(7183, 'toogle_status', '修改状态', 1, 0, 0, 93, 484),
(7182, 'set_sort', '排序', 1, 0, 0, 93, 484),
(7181, 'edit', '编辑', 1, 0, 0, 93, 484),
(7180, 'foreverdelete', '彻底删除', 1, 0, 0, 93, 484),
(7177, 'site_costs_info', '网站收益明细', 1, 0, 0, 230, 6885),
(7178, 'export_csv_site_costs_info', '导出', 1, 0, 0, 230, 6885),
(7179, 'add', '新增', 1, 0, 0, 93, 484),
(7176, 'export_csv_user_total', '导出', 1, 0, 0, 229, 6884),
(7175, 'export_csv_money_carry_bank_total', '导出', 1, 0, 0, 228, 6883),
(7174, 'export_csv_money_inchange_total', '导出', 1, 0, 0, 227, 6882),
(7173, 'export_csv_breach_convention_total', '导出', 1, 0, 0, 226, 6881),
(7172, 'export_csv_financing_amount_total', '导出', 1, 0, 0, 225, 6880),
(7171, 'export_csv_investors_total', '导出', 1, 0, 0, 224, 6879),
(7170, 'export_csv_investe_total', '导出', 1, 0, 0, 223, 6875),
(7169, 'investe_info', '查看项目', 1, 0, 0, 223, 6875),
(7168, 'export_csv_overdue_total', '导出', 1, 0, 0, 222, 6878),
(7167, 'export_csv_hasback_total', '导出', 1, 0, 0, 221, 6877),
(7165, 'export_csv_usernum_total', '导出', 1, 0, 0, 219, 6874),
(7166, 'export_csv_money_total', '导出', 1, 0, 0, 220, 6876),
(7164, 'export_csv_project', '导出', 1, 0, 0, 218, 6872),
(7163, 'project_info', '查看项目', 1, 0, 0, 218, 6872),
(7162, 'edit', '编辑', 1, 0, 0, 212, 6930),
(7161, 'delete', '删除', 1, 0, 0, 212, 6930),
(7206, 'stock_transfer_cancel', '取消交易 ', 1, 0, 0, 211, 6924),
(7158, 'edit_user_bonus', '审核', 1, 0, 0, 209, 6919),
(7157, 'del_user_bonus', '删除', 1, 0, 0, 209, 6919),
(7156, 'foreverdelete', '彻底删除', 1, 0, 0, 192, 641),
(7155, 'edit', '产品编辑上架', 1, 0, 0, 191, 632),
(7154, 'deal_item', '子项目', 1, 0, 0, 191, 632),
(7153, 'submit_house_index', '审核房产众筹', 1, 0, 0, 118, 7153),
(7151, 'del_deal_item', '删除子项目', 1, 0, 0, 118, 7133),
(7152, 'update_deal_item', '更新子项目', 1, 0, 0, 118, 7133),
(7150, 'edit_deal_item', '编辑子项目', 1, 0, 0, 118, 7133),
(7149, 'add_deal_item', '新增子项目', 1, 0, 0, 118, 7133),
(7148, 'deal_item', '子项目列表', 1, 0, 0, 118, 7133),
(7147, 'del_pay_log', '删除发放', 1, 0, 0, 118, 7133),
(7146, 'save_pay_log', '发放', 1, 0, 0, 118, 7133),
(7145, 'pay_log', '筹款发放', 1, 0, 0, 118, 7133),
(7144, 'sharefee_list', '子项目列表', 1, 0, 0, 118, 7133),
(7141, 'deal_log', '项目日志', 1, 0, 0, 118, 7133),
(7142, 'del_deal_log', '删除日志', 1, 0, 0, 118, 7133),
(7140, 'set_sort', '排序', 1, 0, 0, 118, 7133),
(7139, 'add', '新增', 1, 0, 0, 118, 7133),
(7138, 'delete', '删除', 1, 0, 0, 118, 7133),
(7137, 'edit', '编辑', 1, 0, 0, 118, 7133),
(7295, 'edit', '编辑', 1, 0, 0, 192, 641),
(7134, 'house_index', '房产众筹列表', 1, 0, 0, 118, 7134),
(7132, 'foreverdelete', '彻底删除', 1, 0, 0, 136, 689),
(7131, 'delete', '删除', 1, 0, 0, 138, 6868),
(7130, 'edit', '编辑', 1, 0, 0, 138, 6868),
(7129, 'add', '添加', 1, 0, 0, 138, 6868),
(7128, 'set_sort', '排序', 1, 0, 0, 138, 6868),
(7127, 'set_sort', '排序', 1, 0, 0, 121, 642),
(7126, 'set_sort', '排序', 1, 0, 0, 129, 677),
(7125, 'set_effect', '设置状态', 1, 0, 0, 129, 677),
(7124, 'foreverdelete', '彻底删除', 1, 0, 0, 129, 677),
(7123, 'edit', '编辑', 1, 0, 0, 129, 677),
(7122, 'add', '添加', 1, 0, 0, 129, 677),
(7121, 'set_sort', '排序', 1, 0, 0, 130, 680),
(7119, 'foreverdelete', '彻底删除', 1, 0, 0, 130, 680),
(7120, 'set_effect', '设置状态', 1, 0, 0, 130, 680),
(7117, 'add', '添加', 1, 0, 0, 130, 680),
(7118, 'edit', '编辑', 1, 0, 0, 130, 680),
(7116, 'set_sort', '排序', 1, 0, 0, 133, 684),
(7115, 'set_effect', '设置状态', 1, 0, 0, 133, 684),
(7112, 'delete', '删除', 1, 0, 0, 133, 684),
(7113, 'foreverdelete', '彻底删除', 1, 0, 0, 214, 685),
(7114, 'restore', '恢复', 1, 0, 0, 214, 685),
(7111, 'edit', '编辑', 1, 0, 0, 133, 684),
(7110, 'add', '添加', 1, 0, 0, 133, 684),
(7109, 'set_sort', '排序', 1, 0, 0, 134, 686),
(7108, 'set_effect', '设置状态', 1, 0, 0, 134, 686),
(7107, 'restore', '恢复', 1, 0, 0, 213, 687),
(7106, 'foreverdelete', '彻底删除', 1, 0, 0, 213, 687),
(7105, 'delete', '删除', 1, 0, 0, 134, 686),
(7103, 'add', '添加', 1, 0, 0, 134, 686),
(7104, 'edit', '编辑', 1, 0, 0, 134, 686),
(7209, 'refund_allow', '是否允许 ', 1, 0, 0, 126, 664),
(7101, 'export_csv', '导出', 1, 0, 0, 126, 664),
(7100, 'uninstall', '卸载接口', 1, 0, 0, 141, 6871),
(7099, 'edit', '更新托管接口', 1, 0, 0, 141, 6871),
(7098, 'install', '安装托管接口', 1, 0, 0, 141, 6871),
(7096, 'edit', '编辑', 1, 0, 0, 135, 688),
(7097, 'foreverdelete', '彻底删除', 1, 0, 0, 135, 688),
(7095, 'add', '新增', 1, 0, 0, 135, 688),
(7094, 'set_effect', '是否显示', 1, 0, 0, 124, 661),
(7091, 'restore', '回收站恢复', 1, 0, 0, 192, 641),
(7093, 'delete', '删除', 1, 0, 0, 124, 661),
(7092, 'export_csv', '项目导出', 1, 0, 0, 123, 656),
(7085, 'deal_item', '子项目列表', 1, 0, 0, 190, 631),
(7090, 'foreverdelete', '彻底删除', 1, 0, 0, 191, 632),
(7089, 'update_deal_item', '更新子项目', 1, 0, 0, 190, 631),
(7088, 'del_deal_item', '删除子项目', 1, 0, 0, 190, 631),
(7087, 'edit_deal_item', '编辑子项目', 1, 0, 0, 190, 631),
(7086, 'add_deal_item', '新增子项目', 1, 0, 0, 190, 631),
(7447, 'recommend_add', '新增个性推荐', 1, 0, 0, 171, 1),
(7083, 'edit', '编辑', 1, 0, 0, 190, 631),
(7077, 'delete', '移到回收站', 1, 0, 0, 190, 631),
(7082, 'set_sort', '设置排序', 1, 0, 0, 190, 631),
(7448, 'order_export_csv', '导出功能', 1, 0, 0, 171, 0),
(7075, 'add', '新增产品众筹', 1, 0, 0, 190, 631),
(7074, 'delete', '删除', 1, 0, 5, 144, 6887),
(7072, 'set_effect', '设置项目发起的分类', 1, 0, 5, 145, 6886),
(7071, 'delete', '删除', 1, 0, 5, 145, 6886),
(7070, 'edit', '编辑', 1, 0, 5, 145, 6886),
(7133, 'add', '新增', 1, 0, 5, 145, 6886),
(7069, 'delete', '删除', 1, 0, 5, 142, 701),
(7068, 'export_csv', '导出', 1, 0, 5, 142, 701),
(7067, 'edit_dsffreezer', '解冻资金', 1, 0, 5, 152, 6893),
(7066, 'delete', '删除会员等级', 1, 0, 0, 131, 681),
(7065, 'edit', '编辑会员等级', 1, 0, 0, 131, 681),
(7064, 'add', '添加会员等级', 1, 0, 0, 131, 681),
(7063, 'userbank_delete', '删除银行', 1, 0, 0, 113, 0),
(7061, 'userbank_add', '新增银行', 1, 0, 0, 113, 0),
(7062, 'userbank_edit', '编辑银行', 1, 0, 0, 113, 0),
(7060, 'userbank_index', '会员银行列表', 1, 0, 0, 113, 0),
(7059, 'set_effect', '会员状态修改', 1, 0, 0, 113, 607),
(7058, 'edit', '编辑假日', 1, 0, 0, 186, 7055),
(7056, 'add', '新增假日', 1, 0, 0, 186, 7055),
(7057, 'delete', '删除假日', 1, 0, 0, 186, 7055),
(7055, 'index', '假日列表', 1, 0, 0, 186, 7055),
(7053, 'view_order', '查看订单', 1, 0, 0, 185, 7052),
(7054, 'export_csv', '导出', 1, 0, 0, 185, 7052),
(7051, 'set_effect', '修改分类状态', 1, 0, 0, 184, 7047),
(7052, 'index', '兑换商品列表', 1, 0, 0, 185, 7052),
(7050, 'edit', '编辑商品分类', 1, 0, 0, 184, 7047),
(7049, 'delete', '删除商品分类', 1, 0, 0, 184, 7047),
(7048, 'add', '新增商品分类', 1, 0, 0, 184, 7047),
(7045, 'edit', '编辑商品', 1, 0, 0, 183, 7042),
(7046, 'set_effect', '修改状态', 1, 0, 0, 183, 7042),
(7047, 'index', '商品分类列表', 1, 0, 0, 184, 7047),
(7044, 'delete', '删除商品', 1, 0, 0, 183, 7042),
(7043, 'add', '新增商品', 1, 0, 0, 183, 7042),
(7042, 'index', '商品列表', 1, 0, 0, 183, 7042),
(7040, 'update', '收回', 1, 0, 0, 182, 7039),
(7041, 'export_csv', '导出', 1, 0, 0, 182, 7039),
(7039, 'index', '垫付单列表', 1, 0, 0, 182, 7039),
(7038, 'export_csv', '导出', 1, 0, 0, 181, 7036),
(7037, 'view', '查看详情', 1, 0, 0, 181, 7036),
(7036, 'index', '已发放理财列表', 1, 0, 0, 181, 7036),
(7035, 'export_csv', '导出', 1, 0, 0, 180, 7032),
(7034, 'status', '发放理财', 1, 0, 0, 180, 7032),
(7033, 'view', '查看详情', 1, 0, 0, 180, 7032),
(7032, 'index', '快到期理财列表', 1, 0, 0, 180, 7032),
(7031, 'before_index', '预热期赎回列表', 1, 0, 0, 244, 7031),
(7030, 'export_csv', '导出', 1, 0, 0, 179, 7028),
(7029, 'status', '同意赎回', 1, 0, 0, 179, 7028),
(7028, 'index', '赎回管理列表', 1, 0, 0, 179, 7028),
(7021, 'delete', '删除基金品牌', 1, 0, 0, 178, 7018),
(7020, 'edit', '编辑基金品牌', 1, 0, 0, 178, 7018),
(7019, 'add', '新增基金品牌', 1, 0, 0, 178, 7018),
(7018, 'index', '基金品牌列表', 1, 0, 0, 178, 7018),
(7017, 'delete', '删除基金种类', 1, 0, 0, 177, 7014),
(7014, 'index', '基金种类列表', 1, 0, 0, 177, 7014),
(7015, 'add', '新增基金种类', 1, 0, 0, 177, 7014),
(7016, 'edit', '编辑基金种类', 1, 0, 0, 177, 7014),
(7013, 'delete', '删除银行', 1, 0, 0, 176, 7010),
(7012, 'edit', '编辑银行', 1, 0, 0, 176, 7010),
(7011, 'add', '新增银行', 1, 0, 0, 176, 7010),
(7027, 'delete', '删除新增首页订单', 1, 0, 0, 175, 7025),
(7010, 'index', '银行列表', 1, 0, 0, 176, 7010),
(7026, 'edit', '编辑新增首页订单', 1, 0, 0, 175, 7025),
(7025, 'index', '首页订单列表', 1, 0, 0, 175, 7025),
(7009, 'add', '新增首页订单展示', 1, 0, 0, 175, 7025),
(7007, 'edit', '编辑', 1, 0, 0, 174, 7004),
(7008, 'view', '查看详情', 1, 0, 0, 174, 7004),
(7006, 'export_q_csv', '导出功能', 1, 0, 0, 174, 7004),
(7005, 'order_list', '订单列表', 1, 0, 0, 174, 7004),
(7004, 'index', '购买记录列表', 1, 0, 0, 174, 7004),
(7024, 'delete', '删除个性推荐', 1, 0, 0, 173, 7003),
(7023, 'edit', '编辑个性推荐', 1, 0, 0, 173, 7003),
(7022, 'add', '新增个性推荐', 1, 0, 0, 173, 7003),
(7003, 'index', '个性推荐列表', 1, 0, 0, 173, 7003),
(7002, 'edit', '编辑收益率', 1, 0, 0, 172, 6999),
(7001, 'delete', '删除收益率', 1, 0, 0, 172, 6999),
(7000, 'q_add', '新增收益率', 1, 0, 0, 172, 6999),
(6999, 'index', '收益率列表', 1, 0, 0, 172, 6999),
(6998, 'export_csv', '导出功能', 1, 0, 0, 171, 6993),
(6996, 'edit', '编辑', 1, 0, 0, 171, 6993),
(6997, 'set_effect', '设置状态', 1, 0, 0, 171, 6993),
(6995, 'foreverdelete', '彻底删除', 1, 0, 0, 171, 6993),
(6994, 'add', '新增', 1, 0, 0, 171, 6993),
(6993, 'index', '理财列表', 1, 0, 0, 171, 6993),
(6992, 'nav_setting', '自定义菜单列表', 1, 0, 0, 234, 6992),
(6990, 'advanced', '高级群发', 1, 0, 0, 243, 6990),
(6991, 'advanced_add', '新增高级群发信息', 1, 0, 0, 243, 6990),
(6989, 'to_send_message', '推送消息', 1, 0, 0, 242, 6984),
(6988, 'newsAdvItem', '获取高级群发节点', 1, 0, 0, 243, 6990),
(6987, 'formatAdvSendMsg', '格式化模板', 1, 0, 0, 242, 6984),
(6986, 'message_send_del', '删除普通群发信息', 1, 0, 0, 242, 6984),
(6985, 'message_send_add', '新增普通群发信息', 1, 0, 0, 242, 6984),
(6984, 'message_send', '普通消息群发', 1, 0, 0, 242, 6984),
(6983, 'setgroup', '批量粉丝转移', 1, 0, 0, 170, 6980),
(6977, 'groups_synch', '同步微信分组', 1, 0, 0, 241, 6975),
(6982, 'send_info', '刷新所有粉丝', 1, 0, 0, 170, 6980),
(6981, 'send', '获取最新粉丝', 1, 0, 0, 170, 6980),
(6980, 'index', '会员管理', 1, 0, 0, 170, 6980),
(6979, 'groups_editor', '编辑分组', 1, 0, 0, 241, 6975),
(6978, 'delgroups', '删除分组', 1, 0, 0, 241, 6975),
(6976, 'groups_add', '新增分组', 1, 0, 0, 241, 6975),
(6975, 'groups', '分组管理列表', 1, 0, 0, 241, 6975),
(6974, 'reset_sending', '重置队列发送', 1, 0, 0, 240, 6970),
(6972, 'show_content', '模板消息查看', 1, 0, 0, 240, 6970),
(6973, 'send', '模板消息发送', 1, 0, 0, 240, 6970),
(6971, 'foreverdel', '模板消息彻底删除', 1, 0, 0, 240, 6970),
(6970, 'msglist', '模板消息队列', 1, 0, 0, 240, 6970),
(6969, 'install_tmpl', '模板安装', 1, 0, 0, 169, 6968),
(6968, 'index', '模板列表', 1, 0, 0, 169, 6968),
(6967, 'set_industry', '设置行业', 1, 0, 0, 239, 6967),
(6966, 'editlbs', '添加LBS回复', 1, 0, 0, 238, 6965),
(6965, 'lbs', 'LBS回复列表', 1, 0, 0, 238, 6965),
(6964, 'editnews', '添加图文回复', 1, 0, 0, 237, 6963),
(6963, 'news', '图文回复列表', 1, 0, 0, 237, 6963),
(6962, 'delreply', '删除文本回复', 1, 0, 0, 236, 6960),
(6961, 'edittext', '添加文本回复', 1, 0, 0, 236, 6960),
(6960, 'txt', '文本回复列表', 1, 0, 0, 236, 6960),
(6959, 'onfocus', '添加关注时回复', 1, 0, 0, 235, 6959),
(6958, 'index', '默认回复设置', 1, 0, 0, 168, 6958),
(6957, 'syn_to_weixin', '同步到公众平台', 1, 0, 0, 234, 6992),
(6954, 'new_nav_row', '添加主菜单', 1, 0, 0, 234, 6992),
(6955, 'account_remove', '删除', 1, 0, 0, 234, 6992),
(6956, 'nav_save', '保存', 1, 0, 0, 234, 6992),
(6953, 'index', '账户管理', 1, 0, 0, 167, 6953),
(6952, 'update', '编辑', 1, 0, 0, 166, 6951),
(6951, 'index', '第三方平台设置', 1, 0, 0, 166, 6951),
(6950, 'trash', '回收站', 1, 0, 0, 165, 6945),
(6948, 'delete', '删除', 1, 0, 0, 165, 6945),
(6949, 'set_effect', '状态设置', 1, 0, 0, 165, 6945),
(6947, 'edit', '编辑', 1, 0, 0, 165, 6945),
(6945, 'index', '合同范本列表', 1, 0, 0, 165, 6945),
(6946, 'add', '新增', 1, 0, 0, 165, 6945),
(6940, 'index', '站内消息列表', 1, 0, 0, 164, 6940),
(6941, 'add', '新增', 1, 0, 0, 164, 6940),
(6942, 'edit', '编辑', 1, 0, 0, 164, 6940),
(6943, 'foreverdelete', '彻底删除', 1, 0, 0, 164, 6940),
(6944, 'msg_list', '站内消息队列列表', 1, 0, 0, 217, 6944),
(6939, 'vote_info', '查看调查信息', 1, 0, 0, 139, 6869),
(6938, 'vote_result', '查看统计结果', 1, 0, 0, 139, 6869),
(7208, 'install', '安装 ', 1, 0, 0, 119, 633),
(7207, 'edit', '编辑 ', 1, 0, 0, 119, 633),
(7205, 'edit_user_bonus', '审核', 1, 0, 0, 210, 6920),
(6933, 'foreverdelete', '彻底删除', 1, 0, 0, 139, 6869),
(7204, 'del_user_bonus', '删除', 1, 0, 0, 210, 6920),
(6928, 'set_sort', '排序', 1, 0, 0, 162, 6925),
(6929, 'edit', '编辑', 1, 0, 0, 162, 6925),
(6930, 'submit_index', '未审核公司列表', 1, 0, 0, 212, 6930),
(6927, 'toogle_status', '推荐', 1, 0, 0, 162, 6925),
(6926, 'delete', '删除', 1, 0, 0, 162, 6925),
(6925, 'online_index', '公司列表', 1, 0, 0, 162, 6925),
(6924, 'submit_stock_transfer', '股权转让中列表', 1, 0, 0, 211, 6924),
(6923, 'shelves', '未审核转让审核', 1, 0, 0, 161, 6921),
(6922, 'edit_investor', '未审核转让编辑', 1, 0, 0, 161, 6921),
(6921, 'submit_index', '未审核转让列表', 1, 0, 0, 161, 6921),
(6920, 'submit_buy_house_earnings', '未审核买房收益列表', 1, 0, 0, 210, 6920),
(6919, 'submit_fixed_interest', '未审核固定回报列表', 1, 0, 0, 209, 6919),
(6918, 'del_user_bonus', '未审核分红删除', 1, 0, 0, 208, 6916),
(6917, 'edit_user_bonus', '未审核分红审核', 1, 0, 0, 208, 6916),
(6916, 'submit_user_bonus', '未审核分红列表', 1, 0, 0, 208, 6916),
(6915, 'foreverdelete', '删除分类', 1, 0, 0, 160, 6912),
(6914, 'edit', '更新分类', 1, 0, 0, 160, 6912),
(6913, 'add', '添加分类', 1, 0, 0, 160, 6912),
(6912, 'index', '分类列表', 1, 0, 0, 160, 6912),
(6901, 'delete', '删除记录', 1, 0, 0, 156, 6900),
(6900, 'index', '诚意金记录', 1, 0, 0, 156, 6900),
(6899, 'delete', '删除记录', 1, 0, 0, 155, 6898),
(6898, 'index', '提现记录', 1, 0, 0, 155, 6898),
(6897, 'delete', '删除记录', 1, 0, 0, 154, 6896),
(6896, 'index', '充值记录', 1, 0, 0, 154, 6896),
(6895, 'delete', '删除记录', 1, 0, 0, 153, 6894),
(6894, 'index', '诚意金记录', 1, 0, 0, 153, 6894),
(6893, 'index', '申请解冻资金列表', 1, 0, 5, 152, 6893),
(6892, 'edit_dsffreezer', '解冻诚意金', 1, 0, 0, 151, 6891),
(6891, 'index', '冻结资金列表', 1, 0, 5, 151, 6891),
(6911, 'show_content', '申请审核', 1, 0, 5, 137, 6867),
(6887, 'index', '留言列表', 1, 0, 89, 144, 6887),
(6886, 'index', '留言分类列表', 1, 0, 89, 145, 6886),
(6885, 'site_costs_total', '网站费用统计', 1, 0, 88, 230, 6885),
(6884, 'user_total', '用户统计', 1, 0, 88, 229, 6884),
(6883, 'money_carry_bank_total', '提现统计', 1, 0, 88, 228, 6883),
(6882, 'money_inchange_total', '充值统计', 1, 0, 88, 227, 6882),
(6881, 'breach_convention_total', '违约统计', 1, 0, 87, 226, 6881),
(6880, 'financing_amount_total', '融资金额', 1, 0, 87, 225, 6880),
(6879, 'investors_total', '投资人统计', 1, 0, 87, 224, 6879),
(6878, 'overdue_total', '逾期统计', 1, 0, 86, 222, 6878),
(6877, 'hasback_total', '回报统计', 1, 0, 86, 221, 6877),
(6876, 'money_total', '金额统计', 1, 0, 86, 220, 6876),
(6875, 'investe_total', '项目统计', 1, 0, 87, 223, 6875),
(6874, 'usernum_total', '人数统计', 1, 0, 86, 219, 6874),
(6872, 'project', '项目统计', 1, 0, 86, 218, 6872),
(701, 'index', '会员邀请返利列表', 1, 0, 85, 142, 701),
(700, 'referrals_count', '会员邀请统计', 1, 0, 85, 189, 700),
(698, 'sharefee_list', '查看分红列表', 1, 0, 0, 190, 631),
(6870, 'config', '提现手续费', 1, 0, 5, 140, 0),
(695, 'add', '增加页面', 1, 0, 0, 139, 6869),
(697, 'delete', '删除', 1, 0, 0, 139, 6869),
(6869, 'edit', '编辑页面', 1, 0, 0, 139, 6869),
(7210, 'foreverdelete', '彻底删除 ', 1, 0, 0, 216, 668),
(6871, 'index', '资金托管', 1, 0, 75, 141, 6871),
(693, 'index', '问卷调查列表', 1, 0, 84, 139, 6869),
(6868, 'index', '提现银行设置', 1, 0, 5, 138, 6868),
(6867, 'index', '投资申请列表', 1, 0, 69, 137, 6867),
(485, 'savemobile', '保存手机端配置', 1, 0, 0, 12, 483),
(484, 'index', '手机端广告列表', 1, 0, 62, 93, 484),
(483, 'mobile', '手机端配置', 1, 0, 62, 12, 483),
(689, 'index', '系统监测列表', 1, 0, 83, 136, 689),
(688, 'index', '地区列表', 1, 0, 82, 135, 688),
(687, 'trash', '分类回收站', 1, 0, 81, 213, 687),
(686, 'index', '分类列表', 1, 0, 81, 134, 686),
(685, 'trash', '文章回收站', 1, 0, 80, 214, 685),
(684, 'index', '文章列表', 1, 0, 80, 133, 684),
(682, 'index', '项目等级', 0, 0, 72, 132, 682),
(16, 'index', '系统配置', 1, 0, 5, 12, 16),
(17, 'index', '数据库备份列表', 1, 0, 8, 13, 17),
(681, 'index', '会员等级', 1, 0, 69, 131, 681),
(680, 'index', '分组列表', 1, 0, 79, 130, 680),
(677, 'index', '链接列表', 1, 0, 79, 129, 677),
(676, 'foreverdelete', '永久删除', 1, 0, 0, 128, 674),
(675, 'send', '手动发送', 1, 0, 0, 128, 674),
(674, 'index', '推广队列列表', 1, 0, 33, 128, 674),
(673, 'foreverdelete', '删除', 1, 0, 0, 215, 667),
(672, 'index', '查看对列', 1, 0, 0, 216, 668),
(671, 'index', '查看对列', 1, 0, 0, 215, 0),
(269, 'uninstall', '卸载', 1, 0, 0, 48, 58),
(270, 'set_effect', '设置生效', 1, 0, 0, 48, 58),
(271, 'send_demo', '发送测试短信', 1, 0, 0, 48, 58),
(474, 'index', '缓存处理', 1, 0, 0, 92, 474),
(475, 'clear_parse_file', '清空脚本样式缓存', 1, 0, 0, 92, 474),
(477, 'clear_data', '清空数据缓存', 1, 0, 0, 92, 474),
(480, 'syn_data', '同步数据', 1, 0, 0, 92, 474),
(481, 'clear_image', '清空图片缓存', 1, 0, 0, 92, 474),
(482, 'clear_admin', '清空后台缓存', 1, 0, 0, 92, 474),
(605, 'index', '消息模板', 1, 0, 77, 114, 605),
(668, 'sms_index', '短信列表', 1, 0, 0, 216, 668),
(667, 'mail_index', '邮件列表', 1, 0, 28, 215, 667),
(665, 'delete', '删除记录', 1, 0, 0, 126, 664),
(664, 'index', '提现审核列表', 1, 0, 78, 126, 664),
(663, 'delete', '删除记录', 1, 0, 0, 125, 662),
(661, 'index', '项目点评', 1, 0, 74, 124, 661),
(662, 'index', '付款记录', 1, 0, 76, 125, 662),
(660, 'incharge', '项目收款', 1, 0, 0, 123, 656),
(659, 'delete', '删除支持', 1, 0, 0, 123, 656),
(656, 'index', '项目支持', 1, 0, 73, 123, 656),
(657, 'view', '查看详情', 1, 0, 0, 123, 656),
(658, 'refund', '项目退款', 1, 0, 0, 123, 656),
(654, 'del_deal_log', '删除日志', 1, 0, 0, 190, 631),
(655, 'batch_refund', '批量退款', 1, 0, 0, 190, 631),
(653, 'deal_log', '项目日志', 1, 0, 0, 190, 631),
(652, 'del_pay_log', '删除发放', 1, 0, 0, 190, 631),
(650, 'pay_log', '筹款发放', 1, 0, 0, 190, 631),
(651, 'add_pay_log', '发放', 1, 0, 0, 190, 631),
(649, 'foreverdelete', '删除问题', 1, 0, 0, 122, 646),
(646, 'index', '常见问题', 1, 0, 5, 122, 646),
(647, 'add', '添加问题', 1, 0, 0, 122, 646),
(648, 'edit', '更新问题', 1, 0, 0, 122, 646),
(645, 'foreverdelete', '删除帮助', 1, 0, 0, 121, 642),
(644, 'edit', '修改帮助', 1, 0, 0, 121, 642),
(643, 'add', '添加帮助', 1, 0, 0, 121, 642),
(641, 'delete_index', '回收站', 1, 0, 72, 192, 641),
(642, 'index', '帮助列表', 1, 0, 5, 121, 642),
(640, 'foreverdelete', '删除广告', 1, 0, 0, 120, 637),
(639, 'edit', '修改广告', 1, 0, 0, 120, 637),
(638, 'add', '添加广告', 1, 0, 0, 120, 637),
(637, 'index', '轮播广告设置', 1, 0, 5, 120, 637),
(636, 'uninstall', '卸载接口', 1, 0, 0, 119, 633),
(633, 'index', '支付接口列表', 1, 0, 75, 119, 633),
(632, 'submit_index', '未审核项目', 1, 0, 72, 191, 632),
(631, 'online_index', '上线项目列表', 1, 0, 72, 190, 631),
(630, 'foreverdelete', '删除分类', 1, 0, 0, 117, 627),
(628, 'add', '添加分类', 1, 0, 0, 117, 627),
(627, 'index', '分类列表', 1, 0, 72, 117, 627),
(626, 'uninstall', '卸载接口', 1, 0, 0, 116, 623),
(625, 'update', '更新配置', 1, 0, 0, 116, 623),
(624, 'insert', '安装接口', 1, 0, 0, 116, 623),
(623, 'index', '同步登录接口', 1, 0, 71, 116, 623),
(622, 'uninstall', '卸载整合', 1, 0, 0, 115, 620),
(621, 'save', '执行整合', 1, 0, 0, 115, 620),
(620, 'index', '会员整合', 1, 0, 70, 115, 620),
(618, 'weibo', '微博列表', 1, 0, 0, 113, 607),
(619, 'foreverdelete_weibo', '删除微博', 1, 0, 0, 113, 607),
(617, 'foreverdelete_consignee', '删除配送地址', 1, 0, 0, 113, 607),
(616, 'consignee', '配送地址', 1, 0, 0, 113, 607),
(615, 'foreverdelete_account_detail', '删除帐户日志', 1, 0, 0, 113, 607),
(614, 'account_detail', '帐户日志', 1, 0, 0, 113, 607),
(613, 'modify_account', '会员资金变更', 1, 0, 0, 113, 607),
(612, 'delete', '删除会员', 1, 0, 0, 113, 607),
(607, 'index', '会员列表', 1, 0, 69, 113, 607),
(608, 'add', '添加会员', 1, 0, 0, 113, 607),
(610, 'edit', '编辑会员', 1, 0, 0, 113, 607),
(606, 'update', '更新模板', 1, 0, 0, 114, 605),
(265, 'install', '安装', 1, 0, 0, 48, 58),
(267, 'edit', '编辑', 1, 0, 0, 48, 58),
(264, 'foreverdelete', '永久删除', 1, 0, 0, 231, 13),
(263, 'restore', '恢复', 1, 0, 0, 231, 13),
(262, 'delete', '删除', 1, 0, 0, 5, 11),
(261, 'set_effect', '设置生效', 1, 0, 0, 5, 11),
(260, 'update', '编辑执行', 1, 0, 0, 5, 11),
(259, 'edit', '编辑页面', 1, 0, 0, 5, 11),
(258, 'insert', '添加执行', 1, 0, 0, 5, 11),
(257, 'add', '添加页面', 1, 0, 0, 5, 11),
(232, 'set_sort', '排序', 1, 0, 0, 36, 43),
(231, 'set_effect', '设置状态', 1, 0, 0, 36, 43),
(229, 'edit', '编辑', 1, 0, 0, 36, 43),
(211, 'send_demo', '发送测试邮件', 1, 0, 0, 47, 57),
(210, 'foreverdelete', '永久删除', 1, 0, 0, 47, 57),
(209, 'set_effect', '设置状态', 1, 0, 0, 47, 57),
(207, 'edit', '编辑', 1, 0, 0, 47, 57),
(205, 'add', '添加', 1, 0, 0, 47, 57),
(198, 'foreverdelete', '永久删除', 1, 0, 0, 15, 19),
(182, 'deleteImg', '删除图片', 1, 0, 0, 19, 0),
(149, 'foreverdelete', '永久删除', 1, 0, 0, 56, 66),
(181, 'do_upload_img', '图片控件上传', 1, 0, 0, 19, 0),
(148, 'send', '手动发送', 1, 0, 0, 56, 66),
(147, 'show_content', '显示内容', 1, 0, 0, 56, 66),
(105, 'execute', '执行SQL语句', 1, 0, 0, 233, 18),
(102, 'restore', '恢复备份', 1, 0, 0, 13, 17),
(101, 'delete', '删除备份', 1, 0, 0, 13, 17),
(100, 'dump', '备份数据', 1, 0, 0, 13, 17),
(99, 'update', '更新配置', 1, 0, 0, 12, 16),
(81, 'set_effect', '设置生效', 1, 0, 0, 53, 63),
(80, 'foreverdelete', '永久删除', 1, 0, 0, 53, 63),
(78, 'edit', '编辑', 1, 0, 0, 53, 63),
(77, 'add', '添加', 1, 0, 0, 53, 63),
(76, 'set_default', '设置默认管理员', 1, 0, 0, 6, 14),
(75, 'foreverdelete', '永久删除', 1, 0, 0, 232, 15),
(74, 'restore', '恢复', 1, 0, 0, 232, 15),
(73, 'delete', '删除', 1, 0, 0, 6, 14),
(72, 'update', '编辑执行', 1, 0, 0, 6, 14),
(70, 'set_effect', '设置生效', 1, 0, 0, 6, 14),
(68, 'add', '添加页面', 1, 0, 0, 6, 14),
(69, 'edit', '编辑页面', 1, 0, 0, 6, 14),
(66, 'index', '业务队列列表', 1, 0, 33, 56, 66),
(63, 'index', '广告列表', 1, 0, 31, 53, 63),
(58, 'index', '接口列表', 1, 0, 29, 48, 58),
(57, 'index', '邮件服务器列表', 1, 0, 28, 47, 57),
(43, 'index', '菜单列表', 1, 0, 19, 36, 43),
(24, 'do_upload', '编辑器图片上传', 1, 0, 0, 19, 0),
(19, 'index', '系统日志列表', 1, 0, 9, 15, 19),
(18, 'sql', 'SQL操作', 1, 0, 8, 233, 18),
(15, 'trash', '管理员回收站', 1, 0, 7, 232, 15),
(14, 'index', '管理员列表', 1, 0, 7, 6, 14),
(13, 'trash', '管理员分组回收站', 1, 0, 7, 231, 13),
(11, 'index', '管理员分组列表', 1, 0, 7, 5, 11),
(334, 'main', '首页', 1, 0, 1, 58, 0),
(7277, 'export_csv_breach_convention_info', '导出违约统计明细', 1, 0, 0, 226, 6881),
(7278, 'money_inchange_info', '查看', 1, 0, 0, 227, 6882),
(7279, 'export_csv_money_inchange_info', '导出充值明细', 1, 0, 0, 227, 6882),
(7280, 'money_carry_bank_info', '查看', 1, 0, 0, 228, 6883),
(7281, 'export_csv_money_carry_bank_info', '导出提现明细', 1, 0, 0, 228, 6883),
(7282, 'user_info', '查看', 1, 0, 0, 229, 6884),
(7283, 'export_csv_user_info', '导出用户注册明细', 1, 0, 0, 229, 6884),
(7284, 'set_sort', '排序', 1, 0, 0, 120, 637),
(7285, 'index', '固存收益率列表', 1, 0, 0, 188, 7285),
(7286, 'delete', '删除收益率', 1, 0, 0, 188, 7285),
(7287, 'edit', '编辑收益率', 1, 0, 0, 188, 7285),
(7288, 'add', '新增收益率', 1, 0, 0, 188, 7285),
(7289, 'export_csv', '购买记录导出', 1, 0, 0, 174, 7004),
(7290, 'set_status', '拒绝赎回', 1, 0, 0, 244, 7031),
(7291, 'set_status', '拒绝赎回', 1, 0, 0, 179, 7028),
(7292, 'set_status', '发放执行', 1, 0, 0, 180, 7032),
(7293, 'cancel_order', '确认取消', 1, 0, 0, 185, 7052),
(7308, 'set_sort', '排序', 1, 0, 0, 193, 0),
(7297, 'set_sort', '排序', 1, 0, 0, 197, 0),
(7298, 'set_sort', '排序', 1, 0, 0, 201, 0),
(7299, 'edit', '编辑', 1, 0, 0, 193, 0),
(7300, 'edit', '编辑', 1, 0, 0, 197, 0),
(7301, 'edit', '编辑', 1, 0, 0, 201, 0),
(7302, 'foreverdelete', '删除分类', 1, 0, 0, 193, 0),
(7303, 'foreverdelete', '删除分类', 1, 0, 0, 197, 0),
(7304, 'foreverdelete', '删除分类', 1, 0, 0, 201, 0),
(7305, 'add', '添加分类', 1, 0, 0, 193, 0),
(7306, 'add', '添加分类', 1, 0, 0, 197, 0),
(7307, 'add', '添加分类', 1, 0, 0, 201, 0),
(7296, 'index', '分类列表', 1, 0, 0, 193, 0),
(7309, 'index', '分类列表', 1, 0, 0, 197, 0),
(7310, 'index', '分类列表', 1, 0, 0, 201, 0),
(7312, 'get_sharefee_list', '分红列表', 1, 0, 0, 198, 0),
(7313, 'get_sharefee_list', '分红列表', 1, 0, 0, 202, 0),
(7315, 'deal_item', '子项目列表', 1, 0, 0, 194, 0),
(7316, 'deal_item', '子项目列表', 1, 0, 0, 198, 0),
(7317, 'deal_item', '子项目列表', 1, 0, 0, 202, 0),
(7318, 'deal_item', '子项目列表', 1, 0, 0, 205, 0),
(7319, 'update_deal_item', '更新子项目', 1, 0, 0, 194, 0),
(7320, 'update_deal_item', '更新子项目', 1, 0, 0, 198, 0),
(7321, 'update_deal_item', '更新子项目', 1, 0, 0, 202, 0),
(7322, 'update_deal_item', '更新子项目', 1, 0, 0, 205, 0),
(7323, 'del_deal_item', '删除子项目', 1, 0, 0, 194, 0),
(7324, 'del_deal_item', '删除子项目', 1, 0, 0, 198, 0),
(7325, 'del_deal_item', '删除子项目', 1, 0, 0, 202, 0),
(7326, 'del_deal_item', '删除子项目', 1, 0, 0, 205, 0),
(7327, 'edit_deal_item', '编辑子项目', 1, 0, 0, 194, 0),
(7328, 'edit_deal_item', '编辑子项目', 1, 0, 0, 198, 0),
(7329, 'edit_deal_item', '编辑子项目', 1, 0, 0, 202, 0),
(7330, 'edit_deal_item', '编辑子项目', 1, 0, 0, 205, 0),
(7331, 'add_deal_item', '新增子项目', 1, 0, 0, 194, 0),
(7332, 'add_deal_item', '新增子项目', 1, 0, 0, 198, 0),
(7333, 'add_deal_item', '新增子项目', 1, 0, 0, 202, 0),
(7334, 'add_deal_item', '新增子项目', 1, 0, 0, 205, 0),
(7446, 'interest_add', '新增固存收益率', 1, 0, 0, 171, 0),
(7336, 'edit_investor', '编辑股权众筹', 1, 0, 0, 198, 0),
(7337, 'edit_investor', '编辑股权众筹', 1, 0, 0, 202, 0),
(7338, 'edit_investor', '编辑股权众筹', 1, 0, 0, 205, 0),
(7339, 'edit', '编辑', 1, 0, 0, 194, 0),
(7342, 'edit', '编辑', 1, 0, 0, 205, 0),
(7343, 'delete', '移到回收站', 1, 0, 0, 194, 0),
(7344, 'delete', '移到回收站', 1, 0, 0, 198, 0),
(7345, 'delete', '移到回收站', 1, 0, 0, 202, 0),
(7346, 'delete', '移到回收站', 1, 0, 0, 205, 0),
(7347, 'set_sort', '设置排序', 1, 0, 0, 194, 0),
(7348, 'set_sort', '设置排序', 1, 0, 0, 198, 0),
(7349, 'set_sort', '设置排序', 1, 0, 0, 202, 0),
(7350, 'set_sort', '设置排序', 1, 0, 0, 205, 0),
(7352, 'add_investor', '新增股权众筹', 1, 0, 0, 198, 0),
(7353, 'add_investor', '新增股权众筹', 1, 0, 0, 202, 0),
(7354, 'add_investor', '新增股权众筹', 1, 0, 0, 205, 0),
(7355, 'add', '新增公益众筹', 1, 0, 0, 194, 0),
(7445, 'interest_edit', '编辑固存收益率', 1, 0, 0, 171, 0),
(7444, 'interest_delete', '删除固存收益率', 1, 0, 0, 171, 0),
(7358, 'add', '新增产品众筹', 1, 0, 0, 205, 0),
(7359, 'sharefee_list', '查看分红列表', 1, 0, 0, 194, 0),
(7360, 'sharefee_list', '查看分红列表', 1, 0, 0, 198, 0),
(7361, 'sharefee_list', '查看分红列表', 1, 0, 0, 202, 0),
(7362, 'sharefee_list', '查看分红列表', 1, 0, 0, 205, 0),
(7363, 'del_deal_log', '删除日志', 1, 0, 0, 194, 0),
(7364, 'del_deal_log', '删除日志', 1, 0, 0, 198, 0),
(7365, 'del_deal_log', '删除日志', 1, 0, 0, 202, 0),
(7366, 'del_deal_log', '删除日志', 1, 0, 0, 205, 0),
(7367, 'batch_refund', '批量退款', 1, 0, 0, 194, 0),
(7368, 'batch_refund', '批量退款', 1, 0, 0, 198, 0),
(7369, 'batch_refund', '批量退款', 1, 0, 0, 202, 0),
(7370, 'batch_refund', '批量退款', 1, 0, 0, 205, 0),
(7371, 'deal_log', '项目日志', 1, 0, 0, 194, 0),
(7372, 'deal_log', '项目日志', 1, 0, 0, 198, 0),
(7373, 'deal_log', '项目日志', 1, 0, 0, 202, 0),
(7374, 'deal_log', '项目日志', 1, 0, 0, 205, 0),
(7375, 'del_pay_log', '删除发放', 1, 0, 0, 194, 0),
(7376, 'del_pay_log', '删除发放', 1, 0, 0, 198, 0),
(7377, 'del_pay_log', '删除发放', 1, 0, 0, 202, 0),
(7378, 'del_pay_log', '删除发放', 1, 0, 0, 205, 0),
(7379, 'pay_log', '筹款发放', 1, 0, 0, 194, 0),
(7380, 'pay_log', '筹款发放', 1, 0, 0, 198, 0),
(7381, 'pay_log', '筹款发放', 1, 0, 0, 202, 0),
(7382, 'pay_log', '筹款发放', 1, 0, 0, 205, 0),
(7383, 'add_pay_log', '发放', 1, 0, 0, 194, 0),
(7384, 'add_pay_log', '发放', 1, 0, 0, 198, 0),
(7385, 'add_pay_log', '发放', 1, 0, 0, 202, 0),
(7386, 'add_pay_log', '发放', 1, 0, 0, 205, 0),
(7387, 'online_index', '上线项目列表', 1, 0, 0, 194, 0),
(7388, 'online_index', '上线项目列表', 1, 0, 0, 198, 0),
(7389, 'online_index', '上线项目列表', 1, 0, 0, 202, 0),
(7390, 'online_index', '上线项目列表', 1, 0, 0, 205, 0),
(7423, 'add_deal_item', '添加子项目', 1, 0, 0, 195, 0),
(7396, 'add_deal_item', '添加子项目', 1, 0, 0, 199, 0),
(7397, 'add_deal_item', '添加子项目', 1, 0, 0, 203, 0),
(7398, 'add_deal_item', '添加子项目', 1, 0, 0, 206, 0),
(7399, 'del_deal_item', '删除子项目', 1, 0, 0, 195, 0),
(7400, 'del_deal_item', '删除子项目', 1, 0, 0, 199, 0),
(7401, 'del_deal_item', '删除子项目', 1, 0, 0, 203, 0),
(7402, 'del_deal_item', '删除子项目', 1, 0, 0, 206, 0),
(7403, 'edit_deal_item', '编辑子项目', 1, 0, 0, 195, 0),
(7404, 'edit_deal_item', '编辑子项目', 1, 0, 0, 199, 0),
(7405, 'edit_deal_item', '编辑子项目', 1, 0, 0, 203, 0),
(7406, 'edit_deal_item', '编辑子项目', 1, 0, 0, 206, 0),
(7443, 'interest_index', '固存收益率列表', 1, 0, 0, 171, 0),
(7408, 'edit_investor', '股权编辑上架', 1, 0, 0, 199, 0),
(7409, 'edit_investor', '股权编辑上架', 1, 0, 0, 203, 0),
(7411, 'edit', '公益编辑上架', 1, 0, 0, 195, 0),
(7414, 'edit', '编辑上架', 1, 0, 0, 206, 0),
(7415, 'deal_item', '子项目', 1, 0, 0, 195, 0),
(7416, 'deal_item', '子项目', 1, 0, 0, 199, 0),
(7417, 'deal_item', '子项目', 1, 0, 0, 203, 0),
(7418, 'deal_item', '子项目', 1, 0, 0, 206, 0),
(7419, 'foreverdelete', '彻底删除', 1, 0, 0, 195, 0),
(7420, 'foreverdelete', '彻底删除', 1, 0, 0, 199, 0),
(7421, 'foreverdelete', '彻底删除', 1, 0, 0, 203, 0),
(7422, 'foreverdelete', '彻底删除', 1, 0, 0, 206, 0),
(7395, 'submit_index', '未审核项目', 1, 0, 0, 195, 0),
(7424, 'submit_index', '未审核项目', 1, 0, 0, 199, 0),
(7425, 'submit_index', '未审核项目', 1, 0, 0, 203, 0),
(7426, 'submit_index', '未审核项目', 1, 0, 0, 206, 0),
(7427, 'foreverdelete', '彻底删除', 1, 0, 0, 196, 0),
(7428, 'foreverdelete', '彻底删除', 1, 0, 0, 200, 0),
(7429, 'foreverdelete', '彻底删除', 1, 0, 0, 204, 0),
(7430, 'foreverdelete', '彻底删除', 1, 0, 0, 207, 0),
(7431, 'edit', '编辑', 1, 0, 0, 196, 0),
(7432, 'edit_investor', '编辑', 1, 0, 0, 200, 0),
(7433, 'edit_investor', '编辑', 1, 0, 0, 204, 0),
(7434, 'edit', '编辑', 1, 0, 0, 207, 0),
(7435, 'restore', '回收站恢复', 1, 0, 0, 196, 0),
(7436, 'restore', '回收站恢复', 1, 0, 0, 200, 0),
(7437, 'restore', '回收站恢复', 1, 0, 0, 204, 0),
(7438, 'restore', '回收站恢复', 1, 0, 0, 207, 0),
(7439, 'delete_index', '回收站', 1, 0, 0, 196, 0),
(7440, 'delete_index', '回收站', 1, 0, 0, 200, 0),
(7441, 'delete_index', '回收站', 1, 0, 0, 204, 0),
(7442, 'delete_index', '回收站', 1, 0, 0, 207, 0),
(7450, 'dealshow_add', '新增首页订单展示', 1, 0, 0, 171, 0),
(7451, 'history_edit', '编辑余额宝收益率', 1, 0, 0, 171, 0),
(7452, 'history_delete', '删除余额宝收益率', 1, 0, 0, 171, 0),
(7453, 'history_add', '新增余额宝收益率', 1, 0, 0, 171, 0),
(7454, 'history_index', '余额宝收益率列表', 1, 0, 0, 171, 0),
(7455, 'toogle_status', '设置首页类型', 1, 0, 0, 190, 0),
(7456, 'get_pay_list', '支持列表', 1, 0, 0, 190, 0),
(7458, 'get_pay_list', '支持列表', 1, 0, 0, 194, 0),
(7459, 'toogle_status', '设置首页类型', 1, 0, 0, 198, 0),
(7460, 'get_pay_list', '支持列表', 1, 0, 0, 198, 0),
(7461, 'toogle_status', '设置首页类型', 1, 0, 0, 202, 0),
(7462, 'get_pay_list', '支持列表', 1, 0, 0, 202, 0),
(7463, 'toogle_status', '设置首页类型', 1, 0, 0, 205, 0),
(7464, 'get_pay_list', '支持列表', 1, 0, 0, 205, 0);
...
CREATE TABLE IF NOT EXISTS `%DB_PREFIX%sms` (
  ...
  `is_effect` tinyint(1) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='// 短信' AUTO_INCREMENT=9 ;

-- --------------------------------------------------------

--
-- 表的结构 `%DB_PREFIX%sql_check`
--

CREATE TABLE IF NOT EXISTS `%DB_PREFIX%sql_check` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `module` varchar(255) NOT NULL,
  `action` varchar(255) NOT NULL,
  ...
  `create_time` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='//系统监测' AUTO_INCREMENT=109 ;

-- --------------------------------------------------------

--
-- 表的结构 `%DB_PREFIX%stock_transfer`
--

CREATE TABLE IF NOT EXISTS `%DB_PREFIX%stock_transfer` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `deal_name` varchar(255) NOT NULL,
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='//股权转让' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `%DB_PREFIX%user` (
  ...
  KEY `is_effect` (`is_effect`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='//用户信息' AUTO_INCREMENT=20 ;

--
-- 转存表中的数据 `%DB_PREFIX%user`
--

INSERT INTO `%DB_PREFIX%user` (`id`, `user_name`, `user_pwd`, `create_time`, `update_time`, `is_effect`, `email`, `money`, `login_time`, `login_ip`, `province`, `city`, `password_verify`, `sex`, `build_count`, `support_count`, `focus_count`, `integrate_id`, `intro`, `ex_real_name`, `ex_account_bank`, `ex_account_info`, `ex_contact`, `ex_qq`, `code`, `sina_id`, `sina_token`, `sina_secret`, `sina_url`, `tencent_id`, `tencent_token`, `tencent_secret`, `tencent_url`, `verify`, `user_level`, `mobile`, `user_type`, `is_has_send_success`, `is_bank`, `verify_time`, `verify_setting`, `verify_setting_time`, `identify_name`, `identify_number`, `identify_positive_image`, `identify_nagative_image`, `identify_business_licence`, `identify_business_code`, `identify_business_tax`, `identify_business_name`, `is_investor`, `mortgage_money`, `investor_status`, `investor_status_send`, `break_num`, `wx_openid`, `investor_send_info`, `paypassword`, `source_url`, `ips_mer_code`, `ips_acct_no`, `pid`, `score`, `is_send_referrals`, `referral_count`, `point`, `cate_name`, `company`, `job`, `head_image`, `wjdpay_token`, `cy_money`, `concept`, `investment_num`, `investment_begin`, `investment_end`, `gz_region`, `bankLicense`, `orgNo`, `businessLicense`, `contact`, `memberClassType`, `taxNo`, `company_create_time`, `company_english_name`, `company_url`, `focus_company_count`, `card`, `identity_conditions`, `credit_report`, `housing_certificate`, `is_binding`) VALUES
(17, 'fanwe', '6714ccb93be0fda4e51f206b91b46358', 1352227130, 1352227130, 1, '97139915@qq.com', '1200.00', 1434136382, '127.0.0.1', '福建', '福州', '', 1, 3, 1, 1, 0, '方维众筹 - http://zc.fanwe.cn', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', 0, 0, 0, NULL, NULL, 0, '', '', '', '', '', '', '', '', 0, '0.00', 0, 0, 0, '', '', '', '', '', NULL, 0, 0, 0, 0, 0, '', '', '', '', '', '', '', 0, '0.00', '0.00', '', '', '', '', '', NULL, NULL, 0, '', '', 0, '', 3, '', '', 1),
(18, 'fzmatthew', '6714ccb93be0fda4e51f206b91b46358', 1352229180, 1352229180, 1, 'fanwe@fanwe.com', '980.00', 1352246617, '127.0.0.1', '北京', '东城区', '', 1, 1, 3, 1, 0, '爱旅行的猫，生活在路上', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', 0, 0, 0, NULL, NULL, 0, '', '', '', '', '', '', '', '', 0, '0.00', 0, 0, 0, '', '', '', '', '', NULL, 0, 0, 0, 0, 0, '', '', '', '', '', '', '', 0, '0.00', '0.00', '', '', '', '', '', NULL, NULL, 0, '', '', 0, '', 3, '', '', 1),
(19, 'test', '098f6bcd4621d373cade4e832627b4f6', 1352230142, 1352230142, 1, 'test@test.com', '0.00', 1352232937, '127.0.0.1', '广东', '江门', '', 0, 0, 10, 0, 0, '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', 0, 0, 0, NULL, NULL, 0, '', '', '', '', '', '', '', '', 0, '0.00', 0, 0, 0, '', '', '', '', '', NULL, 0, 0, 0, 0, 0, '', '', '', '', '', '', '', 0, '0.00', '0.00', '', '', '', '', '', NULL, NULL, 0, '', '', 0, '', 3, '', '', 1);
...
--
-- 表的结构 `%DB_PREFIX%user_bonus`
--

CREATE TABLE IF NOT EXISTS `%DB_PREFIX%user_bonus` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `%DB_PREFIX%user_bonus_list`
--

CREATE TABLE IF NOT EXISTS `%DB_PREFIX%user_bonus_list` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'id',
...
(2, '5万以内', '10001', '50000', '20.00', 0, 0),
(1, '1万以内', '0', '10000', '10.00', 0, 0);
...
CREATE TABLE IF NOT EXISTS `%DB_PREFIX%user_consignee` (
  ...
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='//收件人' AUTO_INCREMENT=21 ;

-- --------------------------------------------------------

--
-- 表的结构 `%DB_PREFIX%user_deal_notify`
--
...
CREATE TABLE IF NOT EXISTS `%DB_PREFIX%user_deal_notify` (
  ...
  KEY `user_id` (`user_id`),
  KEY `deal_id` (`deal_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='//用于发送下单成功的用户与关注用户的项目成功准备队列' AUTO_INCREMENT=25 ;

--
-- 转存表中的数据 `%DB_PREFIX%user_deal_notify`
--

INSERT INTO `%DB_PREFIX%user_deal_notify` (`id`, `user_id`, `deal_id`, `create_time`) VALUES
(20, 18, 55, 1352229388);
...
CREATE TABLE IF NOT EXISTS `%DB_PREFIX%user_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='//帐户资金变动日志' AUTO_INCREMENT=133 ;

--
-- 转存表中的数据 `%DB_PREFIX%user_log`
--

INSERT INTO `%DB_PREFIX%user_log` (`id`, `log_info`, `log_time`, `log_admin_id`, `money`, `user_id`, `type`, `deal_id`, `score`, `point`, `money_type`, `order_id`) VALUES
(114, '管理员测试充值', 1352229203, 1, 1000.0000, 18, 0, 0, 0, 0, NULL, NULL),
(115, '支持原创DIY桌面游戏《功夫》《黄金密码》期待您的支持项目支付', 1352229388, 1, -20.0000, 18, 0, 0, 0, 0, NULL, NULL),
(116, '管理员测试充值', 1352229989, 1, 2000.0000, 17, 0, 0, 0, 0, NULL, NULL),
(117, '支持拥有自己的咖啡馆项目支付', 1352230101, 1, -500.0000, 17, 0, 0, 0, 0, NULL, NULL),
(118, 'test', 1352230213, 1, 5000.0000, 19, 0, 0, 0, 0, NULL, NULL),
(119, '支持拥有自己的咖啡馆项目支付', 1352230228, 1, -500.0000, 19, 0, 0, 0, 0, NULL, NULL),
(120, '支持拥有自己的咖啡馆项目支付', 1352230232, 1, -500.0000, 19, 0, 0, 0, 0, NULL, NULL),
(121, '支持拥有自己的咖啡馆项目支付', 1352230237, 1, -500.0000, 19, 0, 0, 0, 0, NULL, NULL),
(122, '支持拥有自己的咖啡馆项目支付', 1352230240, 1, -500.0000, 19, 0, 0, 0, 0, NULL, NULL),
(123, '支持拥有自己的咖啡馆项目支付', 1352230243, 1, -500.0000, 19, 0, 0, 0, 0, NULL, NULL),
(124, '支持拥有自己的咖啡馆项目支付', 1352230247, 1, -500.0000, 19, 0, 0, 0, 0, NULL, NULL),
(125, '支持拥有自己的咖啡馆项目支付', 1352230268, 1, -500.0000, 19, 0, 0, 0, 0, NULL, NULL),
(126, '支持拥有自己的咖啡馆项目支付', 1352230270, 1, -500.0000, 19, 0, 0, 0, 0, NULL, NULL),
(127, '支持拥有自己的咖啡馆项目支付', 1352230293, 1, -500.0000, 19, 0, 0, 0, 0, NULL, NULL),
(128, '继续测试', 1352231510, 1, 5000.0000, 18, 0, 0, 0, 0, NULL, NULL),
(129, '支持流浪猫的家—爱天使公益咖啡馆的重建需要大家的力量！项目支付', 1352231539, 1, -2000.0000, 18, 0, 0, 0, 0, NULL, NULL),
(130, '支持流浪猫的家—爱天使公益咖啡馆的重建需要大家的力量！项目支付', 1352231631, 1, -500.0000, 19, 0, 0, 0, 0, NULL, NULL),
(131, '支持拥有自己的咖啡馆项目支付', 1352231671, 1, -300.0000, 17, 0, 0, 0, 0, NULL, NULL),
(132, '支持流浪猫的家—爱天使公益咖啡馆的重建需要大家的力量！项目支付', 1352231704, 1, -3000.0000, 18, 0, 0, 0, 0, NULL, NULL);

-- --------------------------------------------------------

--
-- 表的结构 `%DB_PREFIX%user_message`
--
...
CREATE TABLE IF NOT EXISTS `%DB_PREFIX%user_message` (
  ...
  `is_read` tinyint(1) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='// 用户私信' AUTO_INCREMENT=53 ;

--
-- 转存表中的数据 `%DB_PREFIX%user_message`
--

INSERT INTO `%DB_PREFIX%user_message` (`id`, `create_time`, `message`, `user_id`, `dest_user_id`, `send_user_id`, `receive_user_id`, `user_name`, `dest_user_name`, `send_user_name`, `receive_user_name`, `message_type`, `is_read`) VALUES
...
CREATE TABLE IF NOT EXISTS `%DB_PREFIX%user_notify` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='// 公告' AUTO_INCREMENT=73 ;

--
-- 转存表中的数据 `%DB_PREFIX%user_notify`
--

INSERT INTO `%DB_PREFIX%user_notify` (`id`, `user_id`, `log_info`, `log_time`, `is_read`, `url_route`, `url_param`, `type`) VALUES
(69, 17, '拥有自己的咖啡馆 在 2012-11-07 11:31:10 成功筹到 ¥5,000.00', 1352230271, 0, 'deal#show', 'id=56', 0),
(70, 19, '拥有自己的咖啡馆 在 2012-11-07 11:31:10 成功筹到 ¥5,000.00', 1352230271, 0, 'deal#show', 'id=56', 0),
(71, 17, '您支持的项目拥有自己的咖啡馆回报已发放', 1352230424, 0, 'account#view_order', 'id=66', 0),
(72, 18, '流浪猫的家—爱天使公益咖啡馆的重建需要大家的力量！ 在 2012-11-07 11:55:04 成功筹到 ¥3,000.00', 1352231704, 0, 'deal#show', 'id=58', 0);

-- --------------------------------------------------------

--
-- 表的结构 `%DB_PREFIX%user_refund`
--
...
CREATE TABLE IF NOT EXISTS `%DB_PREFIX%user_refund` (
  ...
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='// 用户退款' AUTO_INCREMENT=5 ;

-- --------------------------------------------------------

--
-- 表的结构 `%DB_PREFIX%user_weibo`
--
...
CREATE TABLE IF NOT EXISTS `%DB_PREFIX%user_weibo` (
  ...
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='//微博' AUTO_INCREMENT=56 ;

--
-- 转存表中的数据 `%DB_PREFIX%user_weibo`
--

INSERT INTO `%DB_PREFIX%user_weibo` (`id`, `user_id`, `weibo_url`) VALUES
(55, 17, 'http://weibo.com/fzmatthew');
...
--
-- 表的结构 `%DB_PREFIX%vote_list`
--

CREATE TABLE IF NOT EXISTS `%DB_PREFIX%vote_list` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='//微信公众号列表' AUTO_INCREMENT=7 ;
...
(1, '第三方平台appid', 'platform_appid', 'appid', 0, 0, '', 0, 1, 1, 1),
(2, '第三方平台token', 'platform_token', 'token', 0, 0, '', 0, 1, 1, 2),
(3, '第三方平台symmetric_key', 'platform_encodingAesKey', 'symmetric_key', 0, 0, '', 0, 1, 1, 3),
(4, '是否开启第三方平台', 'platform_status', '0', 0, 4, '0,1', 0, 1, 1, 4),
(5, '第三方平台AppSecret', 'platform_appsecret', '0', 0, 0, '', 0, 1, 1, 1),
(6, 'component_verify_ticket', 'platform_component_verify_ticket', '0', 0, 0, '', 0, 1, 0, 6),
(7, '第三方平台access_token', 'platform_component_access_token', '0', 0, 0, '', 0, 1, 0, 7),
(8, '第三方平台预授权码', 'platform_pre_auth_code', '0', 0, 0, '', 0, 1, 0, 8),
(9, '第三方平台access_token有效期', 'platform_component_access_token_expire', '0', 0, 0, '', 0, 1, 0, 9),
(10, '第三方平台预授权码有效期', 'platform_pre_auth_code_expire', '0', 0, 0, '', 0, 1, 0, 10);
...
CREATE TABLE IF NOT EXISTS `%DB_PREFIX%weixin_msg_list` (
  ...
  `code` varchar(60) NOT NULL COMMENT '发送的验证码',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='//微信消息列表' AUTO_INCREMENT=1 ;
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='为微信自定义的菜单设置' AUTO_INCREMENT=1 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='商家回复设置表' AUTO_INCREMENT=2 ;
...
CREATE TABLE IF NOT EXISTS `%DB_PREFIX%weixin_tmpl` (
  ...
  `account_id` int(11) DEFAULT '0' COMMENT '所属的商家ID',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='微信模板' AUTO_INCREMENT=1 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='//微信公众号会员列表' AUTO_INCREMENT=733 ;
...
CREATE TABLE IF NOT EXISTS `%DB_PREFIX%yeepay_log` (
  ...
  `html` text,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=71606 ;
