...
require './app/Lib/app_init.php';
	    ...
	    $img_result = save_image_upload($_FILES,"identify_business_code","attachment/".$dir,$whs=array('thumb'=>array(205,160,1,0)),1,1);
	    else
		$img_result = save_image_upload($_FILES,"identify_business_code","attachment/".$dir,$whs=array('thumb'=>array(205,160,1,0)),0,1);	
		...
		$file_url = $img_result['identify_business_code']['url'];
		$thumb_url = $img_result['identify_business_code']['thumb']['thumb']['url'];
		...
		es_session::set("identify_business_code",$data);
